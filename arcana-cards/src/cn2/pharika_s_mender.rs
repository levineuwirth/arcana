...
//! "When this creature enters, you may return target creature or enchantment
...
fn return_from_graveyard(
    ...
    // GAP: target filter only covers creature cards; enchantment cards from
    // graveyard not separately filterable; creature card returning used as best-effort
