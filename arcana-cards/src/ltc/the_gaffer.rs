//! The Gaffer — `{2}{W}` 2/3 Legendary Creature — Halfling Peasant.
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_triggered_ability(TriggeredAbilityDef {
                id: 1,
                trigger_condition: TriggerCondition::StepBegins { step: Step::End, whose: ControllerConstraint::Any },
                intervening_if: None,
                effect: the_gaffer_trigger,
