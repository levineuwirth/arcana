...
//! mana value." Mana value of a permanent isn't exposed via script::*;
//! we tap the target and GAP the mana addition.
...
fn resolve(
    ...
    // GAP: 'add {C} equal to its mana value' — no script::* helper
    // exposes a permanent's mana value, and AddMana wants an explicit
    // per-pip vec.
