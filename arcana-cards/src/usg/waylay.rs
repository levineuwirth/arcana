//! Waylay — `{2}{W}` instant.
//! "Create three 2/2 white Knight creature tokens. Exile them at the beginning
//! of the next cleanup step."
//! GAP: delayed exile trigger at beginning of next cleanup step.
...
fn resolve(
    ...
    let token = TokenDefinition {
        ...
        keywords: vec![],
        // GAP: delayed exile at next cleanup step
        abilities: vec![],
    };
    vec![
