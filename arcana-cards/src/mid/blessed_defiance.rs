//! Blessed Defiance — `{W}` instant. "Target creature you control
//! gets +2/+0 and gains lifelink until end of turn. When that
//! creature dies this turn, create a 1/1 white Spirit creature token
//! with flying."
