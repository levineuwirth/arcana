...
//! or creature. Its controller creates a 2/2 white Ox creature
//! token." The destroyed permanent's controller isn't retrievable
//! for the token rider; the destroy is emitted.
...
fn resolve(_state: &GameState, entry: &StackEntry, _reg: &CardRegistry) -> Vec<Effect> {
    ...
    // GAP: "its controller creates a 2/2 Ox" — the destroyed
    // permanent's controller is not retrievable for the token rider.
