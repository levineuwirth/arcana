...
//! GAP: conditional 'from milled, to hand or else treasure' not expressible; emitting Mill 3 only.
...
fn etb_mill_three(
    ...
    // GAP: conditional 'land from milled to hand, else Treasure' not expressible
