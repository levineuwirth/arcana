//! Bad River — nonbasic land (Mirage, 1996). "This land enters
//! tapped." and "{T}, Sacrifice this land: Search your library for an
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Bad River");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{T}, Sacrifice this land: Search your library for an \
                       Island or Swamp card, put it onto the battlefield, \
                       then shuffle."
                    .into(),
                cost: ActivationCost {
                    tap: true,
