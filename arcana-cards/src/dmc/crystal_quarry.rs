//! Crystal Quarry — nonbasic land (Odyssey, 2001).
//! "{T}: Add {C}." and "{5}, {T}: Add {W}{U}{B}{R}{G}." A colorless mana
//! ability plus a five-color filter ability (one AddMana with all five
//! pips).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Crystal Quarry");
