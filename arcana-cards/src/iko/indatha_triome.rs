//! Indatha Triome — nonbasic land, subtypes Plains Swamp Forest (Ikoria:
//! Lair of Behemoths, 2020). "({T}: Add {W}, {B}, or {G}.)" / "This land
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Indatha Triome");
