//! Savai Crystal — `{3}` artifact.
//! "{T}: Add {R}, {W}, or {B}." and "Cycling {2}". The three-color choice
//! is modeled as THREE separately activatable mana abilities (CR 605.1a /
//! CR 106.3); Cycling is the parametrized keyword — the engine
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Savai Crystal");
