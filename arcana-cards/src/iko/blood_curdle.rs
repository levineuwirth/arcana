...
//! menace counter on a creature you control." GAP: menace-counter
//! kind not in catalog (only PlusOnePlusOne). Express only the
//! destroy.
...
fn resolve(
    ...
    // GAP: menace-counter kind not in CounterKind catalog.
