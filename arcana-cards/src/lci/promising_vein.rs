//! Promising Vein — nonbasic land — Cave (Lost Caverns of Ixalan).
//! "{T}: Add {C}." and "{1}, {T}, Sacrifice this land: Search your
//! library for a basic land card, put it onto the battlefield tapped,
//! then shuffle." The Cave subtype is interned; the fetch uses
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Promising Vein");
