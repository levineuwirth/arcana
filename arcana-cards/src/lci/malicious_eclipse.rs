//! Malicious Eclipse — `{1}{B}{B}` sorcery, "All creatures get -2/-2 until
...
//! this turn, exile it instead' not in catalog.
//! Emitting board-wide -2/-2 Pump only.
...
fn resolve(
    ...
    // GAP: replacement effect (exile instead of dying) not in catalog
