//! Hermitic Nautilus — `{1}{U}` 1/4 Artifact Creature — Nautilus.
//! Vigilance.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Hermitic Nautilus");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{1}{U}: This creature gets +3/-3 until end of turn.".into(),
            cost: ActivationCost {
