//! Undercity Sewers — nonbasic land, subtypes Island Swamp (Murders
//! at Karlov Manor, 2024). "({T}: Add {U} or {B}.) This land enters
//! tapped. When this land enters, surveil 1." Enters tapped, two mana
//! abilities, and an ETB surveil-1 trigger.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Undercity Sewers");
