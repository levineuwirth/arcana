//! Underground Mortuary — nonbasic land, subtypes Swamp Forest
//! (Murders at Karlov Manor, 2024). "({T}: Add {B} or {G}.)", "This
//! land enters tapped." and "When this land enters, surveil 1."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Underground Mortuary");
