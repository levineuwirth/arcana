//! Shadowy Backstreet — nonbasic land — Plains Swamp (Murders at
//! Karlov Manor surveil land).
//! "({T}: Add {W} or {B}.) This land enters tapped. When this land
//! enters, surveil 1."
//!
//! Enters tapped (`EntersWithSpec::Tapped`), two intrinsic basic-land
//! subtype mana abilities, and an ETB surveil trigger.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Shadowy Backstreet");
