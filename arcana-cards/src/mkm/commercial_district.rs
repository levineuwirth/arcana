//! Commercial District — nonbasic land — Mountain Forest (Murders at
//! Karlov Manor, 2024). "({T}: Add {R} or {G}.) This land enters
//! tapped. When this land enters, surveil 1." Enters-tapped plus an
//! ETB surveil trigger; the two-color mana choice is two mana
//! abilities.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Commercial District");
