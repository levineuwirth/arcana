//! Elegant Parlor — nonbasic land — Mountain Plains (Murders at Karlov
//! Manor, 2024). "({T}: Add {R} or {W}.)", "This land enters tapped."
//! and "When this land enters, surveil 1."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Elegant Parlor");
