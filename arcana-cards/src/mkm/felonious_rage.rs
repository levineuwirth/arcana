...
//! Express pump+haste; GAP the dies-trigger-create-token rider.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Felonious Rage");
...
fn resolve(
    ...
    // GAP: dies-this-turn delayed trigger to create token.
