//! Meticulous Archive — Land — Plains Island (Murders at Karlov Manor,
//! 2024). "({T}: Add {W} or {U}.)", "This land enters tapped.", and
//! "When this land enters, surveil 1." A dual-typed tapland with an ETB
//! surveil trigger.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Meticulous Archive");
