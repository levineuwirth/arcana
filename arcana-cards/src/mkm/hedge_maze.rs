//! Hedge Maze — nonbasic land — Forest Island.
//! "({T}: Add {G} or {U}.)" "This land enters tapped." and "When this
//! land enters, surveil 1."
//! Enters-tapped dual with two mana abilities (one per color) and an
//! ETB surveil-1 trigger.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Hedge Maze");
