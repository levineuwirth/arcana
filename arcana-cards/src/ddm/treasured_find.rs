//! Treasured Find — `{B}{G}` sorcery. "Return target card from your graveyard to your hand.
//! Exile Treasured Find."
//!
//! # GAP
//! - No support for the spell exiling itself from the stack / graveyard at resolution
...
fn resolve(
    ...
    // GAP: self-exile after resolution
