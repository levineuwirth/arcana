//! Kyoshi Warrior Guard — vanilla 2/3 white creature for `{1}{W}`.
//! Human Warrior Ally with no abilities; pure stats.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Kyoshi Warrior Guard");
