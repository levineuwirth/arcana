//! Mindlash Sliver — `{B}` 1/1 black Sliver.
//! "All Slivers have `{1}, Sacrifice this permanent: Each player
//! discards a card.`"
//!
//! GAP: "all Slivers have [ability]" — granting ability to all Slivers
//! is a continuous layer effect. Registering self-only as best effort.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Mindlash Sliver");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "All Slivers have \"{1}, Sacrifice this permanent: Each player discards a card.\"".into(),
