//! Long Feng, Grand Secretariat — `{1}{B/G}{B/G}` 2/3 Legendary Creature — Human Advisor.
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_triggered_ability(TriggeredAbilityDef {
                ...
                intervening_if: None,
                effect: long_feng_grand_secretariat_trigger,
...
fn long_feng_grand_secretariat_trigger(
    _state: &GameState,
    trig: &PendingTrigger,
    _reg: &CardRegistry,
) -> Vec<Effect> {
