//! Boar-q-pine — `{2}{R}` 2/2 Boar Porcupine.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Boar-q-pine");
    let boar = reg.interner_mut().intern("Boar");
    let porcupine = reg.interner_mut().intern("Porcupine");
    let mut subtypes = SubtypeSet::default();
    subtypes.0.insert(boar);
    subtypes.0.insert(porcupine);
