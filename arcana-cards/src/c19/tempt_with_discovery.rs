...
//! land card and put it onto the battlefield. Then each player who searched a
//! library this way shuffles."
//! GAP: Tempting offer mechanic (opponents optionally searching, then
//! conditional additional tutors) not expressible.
...
fn resolve(
    ...
    // GAP: Tempting offer mechanic not expressible
