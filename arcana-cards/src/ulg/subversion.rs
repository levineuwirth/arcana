//! Subversion — `{3}{B}{B}` enchantment.
//! "At the beginning of your upkeep, each opponent loses 1 life. You
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Subversion");
