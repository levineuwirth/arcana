...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("King Crab");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{U}, {T}: Put target green creature on top of its owner's library.".into(),
                cost: ActivationCost {
                ...
                face_gate: None,
                effect: put_on_top_of_library,
            }),
    )
}

fn put_on_top_of_library(
    _state: &GameState,
