//! Lynx — `{1}{G}` 2/1 Cat with Forestwalk.
//! Mirage common; a small green Cat with forestwalk, threatening
//! green opponents who control Forests.
//!
//! # Rules references
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Lynx");
