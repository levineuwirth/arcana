//! Aggressive Instinct — `{1}{G}` sorcery. "Target creature you
//! control deals damage equal to its power to target creature you
//! don't control." Resolves as a one-way fight (only the controlled
