//! Wooded Foothills — nonbasic land (fetch land).
//! "{T}, Pay 1 life, Sacrifice this land: Search your library for a
//! Mountain or Forest card, put it onto the battlefield, then
//! shuffle." The fetch is a `TutorToBattlefield` over a
//! Mountain-or-Forest subtype-OR filter; the cost combines tap +
//! 1 life + sacrifice.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Wooded Foothills");
        ...
        CardDefinition::new(name, chars).with_activated_ability(
            ActivatedAbilityDef {
                text: "{T}, Pay 1 life, Sacrifice this land: Search your \
                       library for a Mountain or Forest card, put it onto \
