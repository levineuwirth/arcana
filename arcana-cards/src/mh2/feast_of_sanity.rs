//! Feast of Sanity — `{3}{B}` enchantment.
//! "Whenever you discard a card, this enchantment deals 1 damage to any
//! target and you gain 1 life."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Feast of Sanity");
...
/// "…this enchantment deals 1 damage to any target and you gain 1 life."
fn ping_and_gain(
    _state: &GameState,
    trig: &PendingTrigger,
    _reg: &CardRegistry,
