...
//! your graveyard. Create X 1/1 white Bird creature tokens with flying,
//! where X is the exiled card's toughness."
//!
//! GAP: creating X tokens where X equals the exiled card's toughness
//! (runtime PT lookup) is not expressible with the current Effect catalog.
...
fn resolve(
    ...
    // GAP: X tokens where X = exiled card's toughness (runtime PT lookup)
