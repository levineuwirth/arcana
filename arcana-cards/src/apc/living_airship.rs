//! Living Airship — `{3}{U}` 2/3 Metathran with Flying.
//! "{2}{G}: Regenerate this creature."
//!
//! Flying is a base keyword; the regenerate activation is expressible.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Living Airship");
