//! Drifting Shade — `{3}{B}` 1/1 Shade with Flying.
//! "{B}: This creature gets +1/+1 until end of turn."
//!
//! Flying is an engine keyword. The classic Shade pump is a mana-only
//! activated ability that pumps the source.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Drifting Shade");
