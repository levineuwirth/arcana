//! Dragon's Claw — `{2}` artifact (Mirrodin).
//! "Whenever a player casts a red spell, you may gain 1 life."
//!
//! GAP: the "you may" choice is a resolution-time option with no engine
//! model — modeled as mandatory life gain.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Dragon's Claw");
