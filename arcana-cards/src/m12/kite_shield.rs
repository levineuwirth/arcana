//! Kite Shield — `{0}` artifact — Equipment (Mirrodin, 2003).
//! "Equipped creature gets +0/+3. Equip {3}."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Kite Shield");
...
/// ETB trigger: install the layer-7c "equipped creature gets +0/+3"
