//! Mind Control — `{3}{U}{U}` enchantment — Aura.
//! "Enchant creature. You control enchanted creature."
//!
//! Control-change Aura (mirrors Corrupted Conscience / Control Magic). On ETB
//! (id 1) the host is `source.attached_to`; we `ChangeControl` it to the Aura's
//! controller. When the Aura leaves (id 2) we revert control to the host owner.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Mind Control");
