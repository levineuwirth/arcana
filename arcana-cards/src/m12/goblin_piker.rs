//! Goblin Piker — vanilla 2/1 red creature for `{1}{R}`. No
//! abilities; pure stats. A Goblin Warrior reprinted across many
//! core sets.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Goblin Piker");
