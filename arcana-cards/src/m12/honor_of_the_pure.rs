...
//! control get +1/+1." Filtered layer-7c anthem.
//!
//! Implementation: an ETB trigger installs a
//! [`ContinuousEffect::filtered_pump`] scoped to white creatures you
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Honor of the Pure");
...
/// ETB trigger: install "white creatures you control get +1/+1"
