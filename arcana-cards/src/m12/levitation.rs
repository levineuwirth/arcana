//! Levitation — `{2}{U}{U}` enchantment. "Creatures you control have
//! flying."
//!
//! Implementation: an ETB trigger installs a
//! [`ContinuousEffect::keyword_anthem`] (flying for your creatures) with
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Levitation");
...
/// ETB trigger: install "creatures you control have flying" anchored to
