//! A-Circuit Mender — `{3}` 2/3 colorless Artifact Creature — Insect.
//! "When Circuit Mender enters, you gain 3 life."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("A-Circuit Mender");
...
fn leaves_draw(_state: &GameState, trig: &PendingTrigger, _reg: &CardRegistry) -> Vec<Effect> {
