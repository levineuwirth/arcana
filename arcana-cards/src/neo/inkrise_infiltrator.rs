//! Inkrise Infiltrator — `{1}{B}` 1/2 Human Ninja with Flying.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Inkrise Infiltrator");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{3}{B}: This creature gets +2/+2 until end of turn.".into(),
            cost: ActivationCost {
