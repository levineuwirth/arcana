//! Sacred Foundry — Ravnica shock land. "Land — Mountain Plains", "({T}: Add {R}
//! or {W}.)" and "As this land enters, you may pay 2 life. If you don't, it
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sacred Foundry");
