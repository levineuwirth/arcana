//! Primal Visitation — `{3}{R}{G}` enchantment — Aura.
//! "Enchant creature. Enchanted creature gets +3/+3 and has haste."
//!
//! Buff Aura: +3/+3 (attached_pt) plus a haste grant (attached_keyword),
//! both ETB-installed.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Primal Visitation");
