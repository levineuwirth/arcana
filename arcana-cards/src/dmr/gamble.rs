...
//! card into your hand, discard a card at random, then shuffle." We
//! tutor any card (filter is unconstrained), then discard at random.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Gamble");
