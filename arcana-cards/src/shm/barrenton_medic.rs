//! Barrenton Medic — `{4}{W}` 0/4 Creature — Kithkin Cleric.
//!
//! * {T}: Prevent the next 1 damage that would be dealt to any target this
//!   turn. — tap-cost activated ability, any-target, `PreventDamage` of 1 for
//!   the rest of the turn.
//! * Put a -1/-1 counter on this creature: Untap this creature. — an activated
//!   ability whose cost is placing a -1/-1 counter on itself
//!   (`add_self_counter`), then it untaps itself.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Barrenton Medic");
