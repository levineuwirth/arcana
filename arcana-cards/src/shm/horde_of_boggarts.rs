...
//!
//! Menace is a base keyword. The */* CDA ("equal to the number of red
//! permanents you control") is wired at Layer 7a via
//! `ContinuousEffect::self_pt_from_match` on a `SelfEntersBattlefield`
//! trigger; `PtValue::Star` is kept as the faithful `*/*` bones.
...
/// Layer 7a self-CDA: P/T each equal to the number of red permanents you control.
