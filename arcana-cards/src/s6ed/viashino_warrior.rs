//! Viashino Warrior — vanilla 4/2 red creature for `{3}{R}`.
//! No abilities; a Lizard Warrior with aggressive power-skewed stats.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Viashino Warrior");
