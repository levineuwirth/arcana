...
//! Unscoped color-filtered negative pump (Tempest, 1997).
//!
//! Implementation: an ETB trigger installs a filtered-pump continuous
//! effect of -1/-1 over all white creatures (no controller scope),
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Dread of Night");
...
/// ETB trigger: install "white creatures get -1/-1" (all controllers)
