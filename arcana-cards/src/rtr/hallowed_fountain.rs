//! Hallowed Fountain — Ravnica shock land. "Land — Plains Island", "({T}: Add {W}
//! or {U}.)" and "As this land enters, you may pay 2 life. If you don't, it
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Hallowed Fountain");
