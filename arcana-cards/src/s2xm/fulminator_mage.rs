//! Fulminator Mage — `{1}{B/R}{B/R}` 2/2 black/red Elemental Shaman.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Fulminator Mage");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "Sacrifice this creature: Destroy target nonbasic land.".into(),
                cost: ActivationCost {
                    sacrifice: true,
