//! Disciple of the Vault — `{B}` 1/1 black creature. "Whenever an artifact
//! is put into a graveyard from the battlefield, you may have target opponent
//! lose 1 life."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Disciple of the Vault");
