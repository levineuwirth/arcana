//! Dire Fleet Hoarder — `{1}{B}` 2/1 black Human Pirate.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Dire Fleet Hoarder");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_triggered_ability(TriggeredAbilityDef {
            ...
            intervening_if: None,
            effect: on_dies_create_treasure,
