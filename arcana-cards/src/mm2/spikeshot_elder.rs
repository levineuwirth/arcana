//! Spikeshot Elder — `{R}` 1/1 red Goblin Shaman.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Spikeshot Elder");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{R}{R}: This creature deals damage equal to its power to any target.".into(),
                cost: ActivationCost {
