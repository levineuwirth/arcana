//! Lodestone Myr — `{4}` 2/2 Artifact Creature — Myr with Trample.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Lodestone Myr");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "Tap an untapped artifact you control: This creature gets +1/+1 until end of turn.".into(),
            cost: ActivationCost {
