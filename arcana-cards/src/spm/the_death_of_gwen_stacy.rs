//! The Death of Gwen Stacy — `{2}{B}` black Enchantment — Saga.
...
fn chapter_iii(
    ...
    // GAP: "exile target players' graveyards" not expressible as a whole-graveyard
    // operation; ExileFromGraveyard targets individual cards only
    Vec::new()
}
