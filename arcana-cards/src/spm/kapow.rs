//! Kapow! — `{2}{G}` sorcery. "Put a +1/+1 counter on target creature
//! you control. It fights target creature an opponent controls."
//!
//! Two targets: a creature you control (gets the counter and is the
//! fighter) and a creature an opponent controls (the fight victim).
//! Resolves as `AddCounters` on the first target, then `Fight` between
//! the two.
