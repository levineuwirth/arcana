//! Common Crook — `{1}{B}` 2/2 black Creature — Human Rogue Villain.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Common Crook");
