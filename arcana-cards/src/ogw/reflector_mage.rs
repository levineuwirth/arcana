//! Reflector Mage — `{1}{W}{U}` 2/3 white/blue Creature — Human Wizard.
...
//!
//! # GAP: "can't cast spells with the same name until your next turn" lock effect not expressible.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Reflector Mage");
...
fn etb_bounce_opponent_creature(
    ...
    // GAP: "can't cast spells with the same name until your next turn" not expressible.
