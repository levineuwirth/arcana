//! Training Center — nonbasic land (Commander Legends, 2020).
//! "This land enters tapped unless you have two or more opponents."
//! and "{T}: Add {U} or {R}." Modeled as enters-tapped (faithful in
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Training Center");
