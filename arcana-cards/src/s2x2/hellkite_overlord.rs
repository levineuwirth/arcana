//! Hellkite Overlord — `{4}{B}{R}{R}{G}` 8/8 Dragon with Flying, Trample, Haste.
//!
//! Oracle:
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Hellkite Overlord");
    ...
    let chars = Characteristics {
        name,
        mana_cost: Some(ManaCost::parse("{4}{B}{R}{R}{G}").expect("valid cost")),
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{B}{G}: Regenerate this creature.".into(),
                cost: ActivationCost {
