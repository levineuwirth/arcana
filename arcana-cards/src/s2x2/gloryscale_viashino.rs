...
//! "Whenever you cast a multicolored spell, this creature gets +3/+3 until
//! end of turn."
//! GAP: ObjectFilter has no 'multicolored' predicate; triggering on any spell you cast.
