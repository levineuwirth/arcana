//! Pillar of the Paruns — nonbasic land.
//! "{T}: Add one mana of any color. Spend this mana only to cast a
//! multicolored spell."
//! Modeled as five separately activatable mana abilities, one per
//! WUBRG color. GAP: the "spend this mana only to cast a multicolored
//! spell" restriction is not expressible — plain mana abilities are
//! emitted per the land rules.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Pillar of the Paruns");
...
fn add_white_mana(
    ...
    // GAP: "Spend this mana only to cast a multicolored spell." —
