//! Dawnfeather Eagle — `{4}{W}` 3/3 Creature — Bird (white).
//!
//! * Flying.
//! * "When this creature enters, creatures you control get +1/+1 and gain
//!   vigilance until end of turn." — SelfEnters trigger applying a +1/+1
//!   pump that also grants Vigilance to each creature you control.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Dawnfeather Eagle");
