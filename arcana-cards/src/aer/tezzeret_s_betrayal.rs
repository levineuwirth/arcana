//! Tezzeret's Betrayal — `{3}{U}{B}` sorcery. Destroy target creature.
//! You may search your library and/or graveyard for a card named
//! Tezzeret, Master of Metal, reveal it, and put it into your hand.
...
fn resolve(
    ...
    // GAP: named-card tutor across library and graveyard not in ObjectFilter
    // builders.
