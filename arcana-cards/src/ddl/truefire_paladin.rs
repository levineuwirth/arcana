//! Truefire Paladin — `{R}{W}` 2/2 Human Knight with Vigilance.
//! {R}{W}: +2/+0 until end of turn.  {R}{W}: gains first strike until EOT.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Truefire Paladin");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{R}{W}: This creature gets +2/+0 until end of turn.".into(),
                cost: ActivationCost {
