//! Conquering Manticore — `{4}{R}{R}` 5/5 Manticore with Flying.
//! When this creature enters, gain control of target creature an
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Conquering Manticore");
