//! Zog, Triceraton Castaway — `{4}{R}` 5/4 Legendary Dinosaur Soldier.
//! Reach, trample.
//! When Zog enters, target creature can't block this turn.
//! Mountaincycling {2} — emitted as generic Cycling {2} (the type-search variant
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Zog, Triceraton Castaway");
