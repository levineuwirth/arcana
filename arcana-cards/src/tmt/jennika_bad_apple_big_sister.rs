//! Jennika, Bad Apple Big Sister — `{4}{W}` Legendary 3/3 Mutant Ninja Turtle.
...
//! {2} per engine convention — the type-search rider is not separately
//! modeled).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Jennika, Bad Apple Big Sister");
