//! Oath of the Ancient Wood — `{2}{G}` enchantment.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Oath of the Ancient Wood");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_triggered_ability(
            TriggeredAbilityDef {
                ...
                // enters" — a battlefield-bound ZoneChange over enchantments
                // you control covers both the self-ETB and other
                // enchantments.
