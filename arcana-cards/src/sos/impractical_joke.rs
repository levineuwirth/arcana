//! Impractical Joke — `{R}` sorcery. "Damage can't be prevented this turn.
...
fn resolve(
    ...
    // Note: "damage can't be prevented this turn" has no global-effect Effect variant; omitting it.
