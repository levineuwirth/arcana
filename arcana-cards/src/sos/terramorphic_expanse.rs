//! Terramorphic Expanse — nonbasic land (Time Spiral, 2006).
//! "{T}, Sacrifice this land: Search your library for a basic land
//! card, put it onto the battlefield tapped, then shuffle." The
//! classic fetch: tap + sacrifice-self cost, tutor a basic land to
//! the battlefield tapped (shuffle is automatic).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Terramorphic Expanse");
