//! Bogwater Lumaret — `{B}{G}` 2/2 black/green creature. "Whenever this
//! creature or another creature you control enters, you gain 1 life."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Bogwater Lumaret");
