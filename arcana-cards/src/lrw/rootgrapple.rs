...
//!
//! GAP: conditional draw based on controlling a Treefolk subtype is not
//! expressible. Kindred type (Tribal) is not a supported TypeLine value.
...
fn resolve(
    ...
    // GAP: conditional draw if you control a Treefolk not expressible
