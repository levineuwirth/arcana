//! Kithkin Daggerdare — `{1}{G}` 1/1 Creature — Kithkin Soldier.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Kithkin Daggerdare");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{G}, {T}: Target attacking creature gets +2/+2 until end of turn.".into(),
                cost: ActivationCost {
