//! Riven Turnbull and Princess Lucrezia — `{5}{U}{B}` 10/11 legendary blue/black
//! Human Advisor Wizard. "{T}: Add {U}{B}."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Riven Turnbull and Princess Lucrezia");
