//! Fear of Fear Itself — `{2}{B}{B}` 4/4 black Enchantment Creature — Nightmare.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Fear of Fear Itself");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}: Target creature gains fear until end of turn.".into(),
                cost: ActivationCost {
