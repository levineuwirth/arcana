...
fn resolve(
    ...
    let Some(TargetChoice::Object(a)) = entry.targets.targets.first() else { return Vec::new(); };
    let Some(TargetChoice::Object(b)) = entry.targets.targets.get(1) else { return Vec::new(); };
    vec![
        Effect::Pump {
            target: *a,
            power: 1,
