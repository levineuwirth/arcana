...
//! "{T}: Add {B}, {G}, or {U}." and "{B}{G}{U}, {T}, Sacrifice this
//! artifact: Draw a card." Three mana abilities (the color choice)
//! plus a sacrifice-for-draw activation.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sultai Banner");
