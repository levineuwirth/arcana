//! Abzan Banner — `{3}` artifact (Khans of Tarkir, 2014).
//! "{T}: Add {W}, {B}, or {G}." and "{W}{B}{G}, {T}, Sacrifice this
//! artifact: Draw a card." The or-color mana ability is three
//! separately activatable mana abilities, one per color.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Abzan Banner");
