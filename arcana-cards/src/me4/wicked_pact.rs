...
//!
//! GAP: nonblack creature filter on ObjectFilter (color exclusion not
//! available); two creature targets resolved as separate DestroyPermanent.
...
fn resolve(
    ...
    // GAP: nonblack color filter not in ObjectFilter
