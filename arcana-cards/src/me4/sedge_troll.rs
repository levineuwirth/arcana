...
//!
//! * This creature gets +1/+1 as long as you control a Swamp. — GAP: a
//!   conditional continuous static (no trigger word, no cost). Not
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sedge Troll");
