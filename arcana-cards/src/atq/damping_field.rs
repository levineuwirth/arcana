//! Damping Field — `{2}{W}` enchantment. "Players can't untap more
//! than one artifact during their untap steps."
//!
//! Implementation: an ETB trigger installs a
//! [`ContinuousEffect::untap_cap`] of 1 scoped to artifacts, with
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Damping Field");
...
/// ETB trigger: install "players can't untap more than one artifact
