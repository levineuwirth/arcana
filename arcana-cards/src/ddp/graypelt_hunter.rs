//! Graypelt Hunter — `{3}{G}` 2/2 Human Warrior Ally. Trample.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Graypelt Hunter");
...
fn add_counter(_state: &GameState, trig: &PendingTrigger, _reg: &CardRegistry) -> Vec<Effect> {
    // "you may put a +1/+1 counter on this creature" — the may is a
    // resolution-time choice the engine handles.
