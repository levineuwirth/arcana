//! Bloodrite Invoker — `{2}{B}` 3/1 black Vampire Shaman.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Bloodrite Invoker");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{8}: Target player loses 3 life and you gain 3 life.".into(),
                cost: ActivationCost {
