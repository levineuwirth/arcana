//! Bitterbloom Bearer — `{B}{B}` 1/1 Faerie Rogue with Flash and
//! Flying. "At the beginning of your upkeep, you lose 1 life and
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Bitterbloom Bearer");
...
fn upkeep_faerie(_state: &GameState, trig: &PendingTrigger, reg: &CardRegistry) -> Vec<Effect> {
