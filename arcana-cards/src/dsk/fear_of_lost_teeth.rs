//! Fear of Lost Teeth — `{B}` 1/1 black Enchantment Creature — Nightmare.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Fear of Lost Teeth");
...
fn on_dies_drain(
    ...
    vec![
        Effect::DealDamage { target: dt, amount: 1, source: trig.source },
