//! Neglected Manor — nonbasic land (Wilds of Eldraine, 2023).
//! "This land enters tapped unless a player has 13 or less life." and
//! "{T}: Add {W} or {B}." The conditional enters-tapped is modeled as
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Neglected Manor");
