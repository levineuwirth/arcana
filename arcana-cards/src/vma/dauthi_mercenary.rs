//! Dauthi Mercenary — `{2}{B}` 2/1 Creature — Dauthi Knight Mercenary.
//!
//! Oracle:
//! * Shadow.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Dauthi Mercenary");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{1}{B}: This creature gets +1/+0 until end of turn.".into(),
            cost: ActivationCost {
