//! Devout Witness — `{2}{W}` 2/2 Human Spellshaper.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Devout Witness");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{W}, {T}, Discard a card: Destroy target artifact or enchantment.".into(),
                cost: ActivationCost {
