//! Flowstone Hellion — `{4}{R}` 3/3 Hellion Beast with Haste.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Flowstone Hellion");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{0}: This creature gets +1/-1 until end of turn.".into(),
            cost: ActivationCost {
