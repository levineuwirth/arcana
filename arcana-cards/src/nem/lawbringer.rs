//! Lawbringer — `{2}{W}` 2/2 white Kor Rebel.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Lawbringer");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{T}, Sacrifice this creature: Exile target red creature.".into(),
                cost: ActivationCost {
                    tap: true,
                    sacrifice: true,
                ...
                face_gate: None,
                effect: exile_red_creature,
            }),
    )
}

fn exile_red_creature(
    _state: &GameState,
