//! Laccolith Titan — `{5}{R}{R}` 6/6 red Beast.
...
//! GAP: optional redirect of power damage + zero combat damage assignment not expressible;
//! emitting DealDamage to target creature (power-based, dynamic).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Laccolith Titan");
...
fn deal_power_damage(
    ...
    // GAP: "no combat damage this turn" side effect not expressible
