//! Ancient Hydra — `{4}{R}` 5/1 Hydra with Fading 5.
//!
//! Oracle:
//! * Fading 5.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Ancient Hydra");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}, Remove a fade counter from this creature: It deals 1 damage to any target.".into(),
                cost: ActivationCost {
