//! Fallaji Chaindancer — `{3}{R}` 2/4 Human Soldier.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Fallaji Chaindancer");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}: This creature gains double strike until end of turn.".into(),
                cost: ActivationCost {
