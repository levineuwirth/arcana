...
//!
//! # GAP: stun counters (CounterKind::Stun) are not listed in the
//! Effect catalog. The Tap effects are emitted; the stun-counter
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_spell_ability(SpellAbilityDef {
                text: "Tap up to two target artifacts and/or creatures. Put two stun counters on each of them.".into(),
...
fn resolve(
    ...
    // GAP: CounterKind::Stun not in catalog; stun counters omitted
