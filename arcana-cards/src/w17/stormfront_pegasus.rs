...
//! Common from Magic 2011 (2010); an aggressive two-drop white flier
//! with fragile toughness, suited for aerial pressure.
//!
//! # Rules references
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Stormfront Pegasus");
