//! Power of Fire — `{1}{R}` enchantment — Aura.
...
//! effect granting the host '{T}: deal 1 damage to any target' — cost and
//! effect run against the enchanted creature.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Power of Fire");
