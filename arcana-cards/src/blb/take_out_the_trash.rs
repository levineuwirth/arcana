//! Take Out the Trash — `{1}{R}` instant. "Take Out the Trash deals 3
//! damage to target creature or planeswalker. If you control a
//! Raccoon, you may discard a card. If you do, draw a card."
//!
//! The damage is expressed. The optional discard-then-draw rider gated
//! on controlling a Raccoon is not expressible — GAP.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Take Out the Trash");
...
fn resolve(_state: &GameState, entry: &StackEntry, _reg: &CardRegistry) -> Vec<Effect> {
    ...
    // GAP: optional "if you control a Raccoon, you may discard a card;
    // if you do, draw a card" rider is not expressible.
