...
//! via `source.attached_to`, the Gremlin Infestation exemplar). The "attacks
//! each combat if able" attack requirement has no attached_* builder, so that
//! clause is GAP'd.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    ...
    reg.register(
        // GAP: "enchanted creature attacks each combat if able" attack
        // requirement has no attached_* builder.
