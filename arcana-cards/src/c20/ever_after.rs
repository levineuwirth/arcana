//! Ever After — `{4}{B}{B}` sorcery. "Return up to two target
//! creature cards from your graveyard to the battlefield. Each of
//! those creatures is a black Zombie in addition to its other colors
//! and types. Put Ever After on the bottom of its owner's library."
...
fn resolve(
    ...
    // GAP: "black Zombie in addition to other colors/types" type-and-
    // color graft, and "put this on the bottom of its owner's
    // library" self-bottoming primitive are not in the catalog.
    effects
}
