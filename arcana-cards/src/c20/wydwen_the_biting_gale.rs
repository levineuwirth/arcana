//! Wydwen, the Biting Gale — `{2}{U}{B}` 3/3 Legendary Faerie Wizard.
//! Flash, Flying.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Wydwen, the Biting Gale");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{U}{B}, Pay 1 life: Return Wydwen to its owner's hand.".into(),
                cost: ActivationCost {
