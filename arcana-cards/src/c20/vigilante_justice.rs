//! Vigilante Justice — `{3}{R}` enchantment.
//! "Whenever a Human you control enters, this enchantment deals 1
//! damage to any target."
//!
//! A battlefield-bound `ZoneChange` trigger filtered to Humans you
//! control, with an any-target requirement read via the full
//! three-arm `TargetChoice` match.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Vigilante Justice");
