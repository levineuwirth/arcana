//! Stingmoggie — `{3}{R}` 0/0 Elemental.
//! "This creature enters with two +1/+1 counters on it.
//!  {3}{R}, Remove a +1/+1 counter from this creature: Destroy target
//!  artifact or land."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Stingmoggie");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{3}{R}, Remove a +1/+1 counter from this creature: Destroy target artifact or land."
                    .into(),
                cost: ActivationCost {
