//! Rakeclaw Gargantuan — `{2}{R}{G}{W}` 5/3 Beast.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Rakeclaw Gargantuan");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}: Target creature with power 5 or greater gains first strike until end of turn.".into(),
                cost: ActivationCost {
