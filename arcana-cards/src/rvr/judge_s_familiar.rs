//! Judge's Familiar — `{W/U}` 1/1 Bird with Flying.
//!
//! Oracle:
//! * Flying
...
//! 2. Sacrifice-self activated ability → Effect::CounterUnlessPays on a target
//!    instant-or-sorcery spell, unless its controller pays {1}.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Judge's Familiar");
