//! Illvoi Galeblade — `{U}` 1/1 Jellyfish Warrior with Flash and Flying.
//!
//! * Flash, Flying (keywords).
//! * "{2}, Sacrifice this creature: Draw a card." — mana + sacrifice-self
//!   activation that draws a card.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Illvoi Galeblade");
