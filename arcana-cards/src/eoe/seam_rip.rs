...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Seam Rip");
...
/// "…exile target nonland permanent an opponent controls with mana
/// value 2 or less until this enchantment leaves the battlefield."
fn etb_exile(
    _state: &GameState,
    trig: &PendingTrigger,
    _reg: &CardRegistry,
