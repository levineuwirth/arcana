...
//! 'If they do' branch can't read whether the soft-counter was paid
//! against — CounterUnlessPays resolves the prompt inside the engine,
//! and the resolver has no follow-up signal.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Divert Disaster");
...
fn resolve(
    ...
    // GAP: 'if they do, create a Lander' — no resolver-visible signal
    // for whether the soft-counter was paid.
