...
//!
//! GAP: opponent-may-cheat-creature-into-play rider has no catalog
//! Effect; only the counter is modeled.
...
fn resolve(_state: &GameState, entry: &StackEntry, _reg: &CardRegistry) -> Vec<Effect> {
    ...
    // GAP: 'controller may put a creature from hand onto battlefield' rider not in catalog.
