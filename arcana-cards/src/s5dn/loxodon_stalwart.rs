//! Loxodon Stalwart — `{3}{W}{W}` 3/3 Elephant Soldier with Vigilance.
//!
//! "{W}: This creature gets +0/+1 until end of turn." — activated pump.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Loxodon Stalwart");
