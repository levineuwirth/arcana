//! Advanced Hoverguard — `{3}{U}` 2/2 Drone with Flying.
//!
//! * Flying — base keyword.
//! * "{U}: This creature gains shroud until end of turn." — mana activation
//!   granting shroud to itself.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Advanced Hoverguard");
