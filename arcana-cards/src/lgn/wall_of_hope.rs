//! Wall of Hope — `{W}` 0/3 Wall with Defender.
//! "Whenever this creature is dealt damage, you gain that much life."
//!
//! Defender is a base keyword. The dealt-damage trigger gains life equal
//! to the damage taken, read via `trig.damage_amount()`.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Wall of Hope");
