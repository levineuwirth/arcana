//! Cateran Kidnappers — `{2}{B}{B}` 4/2 black Human Mercenary.
//! "{3}, {T}: Search your library for a Mercenary permanent card with mana value 3
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Cateran Kidnappers");
