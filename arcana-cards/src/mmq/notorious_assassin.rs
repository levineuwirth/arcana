//! Notorious Assassin — `{3}{B}` 2/2 black Human Spellshaper Assassin.
//! "{2}{B}, {T}, Discard a card: Destroy target nonblack creature. It can't
//! be regenerated."
//! GAP: "can't be regenerated" is not an Effect; using DestroyPermanent.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Notorious Assassin");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}{B}, {T}, Discard a card: Destroy target nonblack creature. It can't be regenerated.".into(),
                cost: ActivationCost {
