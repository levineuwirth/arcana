//! Deepwood Drummer — `{1}{G}` 1/1 green Human Spellshaper. "{G}, {T}, Discard
//! a card: Target creature gets +2/+2 until end of turn."
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Deepwood Drummer");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{G}, {T}, Discard a card: Target creature gets +2/+2 until end of turn.".into(),
                cost: ActivationCost {
