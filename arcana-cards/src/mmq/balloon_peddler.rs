//! Balloon Peddler — `{2}{U}` 2/2 Human Spellshaper.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Balloon Peddler");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{U}, {T}, Discard a card: Target creature gains flying until end of turn.".into(),
                cost: ActivationCost {
