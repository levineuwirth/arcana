//! Lunge — `{2}{R}` instant. "Lunge deals 2 damage to target creature and 2
...
fn resolve(
    ...
    vec![
        Effect::DealDamage { source: entry.source, target: dt1, amount: 2 },
        Effect::DealDamage { source: entry.source, target: dt2, amount: 2 },
    ]
}
