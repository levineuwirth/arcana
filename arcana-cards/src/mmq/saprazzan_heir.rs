//! Saprazzan Heir — `{1}{U}` 1/1 blue Merfolk creature.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Saprazzan Heir");
    ...
    // GAP: trigger — "becomes blocked" not in TriggerCondition catalog; using SelfAttacks as placeholder
    reg.register(
