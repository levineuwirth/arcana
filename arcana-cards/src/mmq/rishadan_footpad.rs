//! Rishadan Footpad — `{3}{U}` 2/2 blue Human Pirate.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Rishadan Footpad");
...
fn tax_opponents(
    ...
    // For each opponent: pay {2} or sacrifice a permanent (inverted polarity: else = sacrifice)
