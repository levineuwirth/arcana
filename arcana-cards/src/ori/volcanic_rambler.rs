//! Volcanic Rambler — `{5}{R}` 6/4 red Elemental. "{2}{R}: This creature deals
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Volcanic Rambler");
            ...
            .with_activated_ability(ActivatedAbilityDef {
                ...
                target_requirements: vec![TargetRequirement {
                    filter: TargetFilter::Permanent(
                        ObjectFilter::new().with_types_any(TypeLine(TypeLine::PLANESWALKER | TypeLine::CREATURE)),
                    ),
