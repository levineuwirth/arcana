//! Wild Instincts — `{3}{G}` sorcery. "Target creature you control
//! gets +2/+2 until end of turn. It fights target creature an
//! opponent controls."
//!
//! Two targets: the first a creature you control (gets +2/+2), the
//! second a creature an opponent controls (the two fight).
