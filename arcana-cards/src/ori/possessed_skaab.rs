//! Possessed Skaab — `{3}{U}{B}` 3/2 Zombie.
//!
//! * When this creature enters, return target instant, sorcery, or creature card
//!   from your graveyard to your hand.
//! * If this creature would die, exile it instead. (GAP — die-replacement
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Possessed Skaab");
    ...
    // GAP: "If this creature would die, exile it instead" — die-replacement, not
    // expressible.
    reg.register(
