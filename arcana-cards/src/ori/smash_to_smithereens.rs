...
//! Smash to Smithereens deals 3 damage to that artifact's
//! controller."
//!
//! GAP: "3 damage to that artifact's controller" needs a
//! controller-of-target resolver, not available. The destroy is
//! emitted.
...
fn resolve(_state: &GameState, entry: &StackEntry, _reg: &CardRegistry) -> Vec<Effect> {
    ...
    // GAP: "3 damage to that artifact's controller" — no controller-of-target resolver.
