//! Wreath of Geists — `{G}` enchantment — Aura.
...
//! counts creature cards in the Aura controller's graveyard (a type-only
//! filter, fully expressible) and returns (X, X).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Wreath of Geists");
