//! Sturmgeist — `{3}{U}{U}` */* blue Spirit.
//! Flying. Its power and toughness are each equal to the number of cards
//! in your hand (a CDA, installed as a Layer 7a self-CDA on ETB via
//! `ContinuousEffect::self_pt_cda`; PtValue::Star marks the bones).
//! Whenever it deals combat damage to a player, draw a card.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sturmgeist");
