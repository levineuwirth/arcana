//! Angel of Despair — `{3}{W}{W}{B}{B}` 5/5 Angel with Flying.
//! "When this creature enters, destroy target permanent."
//!
//! Flying is a base keyword. The ETB destroys the targeted permanent.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Angel of Despair");
