//! Back to Basics — `{2}{U}` enchantment. "Nonbasic lands don't untap
//! during their controllers' untap steps."
//!
//! Implementation: an ETB trigger installs a
//! [`ContinuousEffect::filtered_dont_untap`] scoped to lands without
//! the Basic supertype, with duration
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Back to Basics");
...
/// ETB trigger: install "nonbasic lands don't untap during their
...
fn etb_install_untap_restriction(
    ...
    vec![Effect::InstallContinuousEffect {
        effect: ContinuousEffect::filtered_dont_untap(
            ...
            .without_supertypes(SupertypeSet(SupertypeSet::BASIC)),
