//! Stone Kavu — `{4}{G}` 3/3 Kavu.
//!
//! "{R}: This creature gets +1/+0 until end of turn.
//!  {W}: This creature gets +0/+1 until end of turn."
//!
//! Decomposition: two mana-cost activated abilities that pump this
//! creature (self-targeted) until end of turn.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Stone Kavu");
