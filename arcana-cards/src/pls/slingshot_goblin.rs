//! Slingshot Goblin — `{2}{R}` 2/2 red Goblin.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Slingshot Goblin");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{R}, {T}: This creature deals 2 damage to target blue creature.".into(),
                cost: ActivationCost {
