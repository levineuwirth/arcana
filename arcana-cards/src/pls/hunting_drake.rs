//! Hunting Drake — `{4}{U}` 2/2 Drake with Flying.
//! When this creature enters, put target red or green creature on top
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Hunting Drake");
