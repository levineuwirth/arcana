...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Caldera Kavu");
...
fn become_color_of_choice(
    _state: &GameState,
    _ctx: &ActivationContext,
    _reg: &CardRegistry,
) -> Vec<Effect> {
    // GAP: "becomes the color of your choice" — Effect::SetColor needs a concrete
    // ColorSet; there is no player color-choice mechanism in the Effect surface.
    Vec::new()
}
