//! Chaos Maw — `{5}{R}{R}` 6/6 red creature. "When this creature enters,
//! it deals 3 damage to each other creature."
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_triggered_ability(TriggeredAbilityDef {
                ...
                intervening_if: None,
                effect: etb_deal_damage_all_other_creatures,
...
fn etb_deal_damage_all_other_creatures(
    state: &GameState,
    trig: &PendingTrigger,
    _reg: &CardRegistry,
) -> Vec<Effect> {
