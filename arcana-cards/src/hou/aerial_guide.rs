//! Aerial Guide — `{2}{U}` 2/2 blue Drake with Flying.
//!
//! * Flying (keyword line).
//! * Whenever this creature attacks, another target attacking creature
//!   gains flying until end of turn. (The "another" self-exclusion isn't
//!   a filter constraint here; the attacking-creature target is wired.)
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Aerial Guide");
