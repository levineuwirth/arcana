//! Emissary of Sunrise — `{2}{W}` 2/1 Human Cleric with First strike.
//! "When this creature enters, it explores."
//!
//! First strike is a base keyword. The ETB explore trigger uses Effect::Explore on
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Emissary of Sunrise");
