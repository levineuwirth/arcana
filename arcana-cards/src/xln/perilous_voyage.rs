//! Perilous Voyage — `{1}{U}` instant, "Return target nonland permanent you don't control to its
//! owner's hand. If its mana value was 2 or less, scry 2."
//!
//! GAP: No engine support for conditional effect based on bounced permanent's mana value.
...
fn resolve(
    ...
    // GAP: No engine support for conditional scry based on bounced permanent's mana value
