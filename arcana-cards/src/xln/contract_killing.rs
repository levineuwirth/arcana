//! Contract Killing — `{3}{B}{B}` sorcery. "Destroy target creature. Create two
//! Treasure tokens."
//!
//! # GAP: Treasure token activated ability ("{T}, Sacrifice: Add one mana of any color")
...
fn resolve(
    ...
    let token = TokenDefinition {
        ...
        toughness: None,
        keywords: vec![],
        // GAP: Treasure activated ability not expressible
        abilities: vec![],
    };
    vec![
