//! Headwater Sentries — vanilla 2/5 blue creature for `{3}{U}`.
//! No abilities; pure stats. Creature types: Merfolk Warrior.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Headwater Sentries");
