//! Advance Scout — `{1}{W}` 1/1 white Human Soldier Scout with First strike.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Advance Scout");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{W}: Target creature gains first strike until end of turn.".into(),
                cost: ActivationCost {
