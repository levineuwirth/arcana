//! Cloudcrest Lake — nonbasic land.
//! "{T}: Add {C}." and "{T}: Add {W} or {U}. This land doesn't untap
//! during your next untap step." Three mana abilities (colorless plus
//! the two-color choice as two abilities). The doesn't-untap rider is
//! not expressible — GAP.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Cloudcrest Lake");
...
fn add_white_mana(
    ...
    // untap-skip riders are not expressible; plain mana emitted.
    vec![Effect::AddMana {
        player: ctx.controller,
