//! Okina, Temple to the Grandfathers — legendary land (Champions of
//! Kamigawa, 2004). "{T}: Add {G}." and "{G}, {T}: Target legendary
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Okina, Temple to the Grandfathers");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{G}, {T}: Target legendary creature gets +1/+1 \
                       until end of turn."
                    .into(),
                cost: ActivationCost {
