//! Cruel Celebrant — `{W}{B}` 1/2 white-black Creature — Vampire.
//! "Whenever this creature or another creature or planeswalker you control dies,
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_triggered_ability(TriggeredAbilityDef {
                id: 1,
                // Trigger on any creature/planeswalker you control dying.
                // GAP: planeswalker type not filterable in ObjectFilter; approximating with creature.
