...
pub fn register(reg: &mut CardRegistry) -> CardId {
    ...
    reg.register(
        CardDefinition::new(name, chars).with_spell_ability(SpellAbilityDef {
            text: "Destroy target permanent. Its controller creates a 3/3 \
...
fn resolve(
    ...
    // GAP: cannot create the Elephant token for the destroyed permanent's
    // controller (no controller-of-target accessor).
