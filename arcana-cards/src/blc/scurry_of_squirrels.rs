//! Scurry of Squirrels — `{2}{G}` 2/2 Squirrel Scout.
//! Myriad (GAP: not an expressible keyword/mechanic).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Scurry of Squirrels");
    ...
    // GAP: keyword "Myriad" — not an expressible KeywordAbility variant
    // and the copy-on-attack myriad mechanic is unmodeled.
