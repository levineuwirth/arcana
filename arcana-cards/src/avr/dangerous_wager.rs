//! Dangerous Wager — `{1}{R}` instant. "Discard your hand, then draw
//! two cards." Discard 'your hand' = discard all cards in hand. We
//! size with script::hand_size for the discard count.
