//! Golgari Germination — `{1}{B}{G}` enchantment.
//! "Whenever a nontoken creature you control dies, create a 1/1 green
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Golgari Germination");
...
fn make_saproling(
    ...
    subtypes.0.insert(saproling.clone());
