//! Merciless Harlequin — `{2}{B}` 2/1 Human Assassin.
//! Freerunning {1}{B} (alternative cost — not modeled, see GAP).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Merciless Harlequin");
    ...
    let chars = Characteristics {
        ...
        // GAP: Freerunning {1}{B} alternative cast cost not expressible.
        ..Default::default()
    };
