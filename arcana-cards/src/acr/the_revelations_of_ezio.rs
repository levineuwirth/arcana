//! The Revelations of Ezio — `{2}{B}` Enchantment — Saga
//!
//! I — Destroy target tapped creature an opponent controls.
//! II — Whenever an Assassin you control attacks this turn, put a +1/+1
//!      counter on it. (GAP: this-turn-only trigger deferred; Vec::new().)
//! III — Return target Assassin creature card from your graveyard to the
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("The Revelations of Ezio");
        ...
        CardDefinition::new(name, chars)
            ...
            .with_triggered_ability(TriggeredAbilityDef {
                ...
                target_requirements: vec![TargetRequirement {
                    filter: TargetFilter::Permanent(ObjectFilter::creature().controlled_by(ControllerConstraint::Opponent).tapped_only()),
