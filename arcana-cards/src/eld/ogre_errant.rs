//! Ogre Errant — `{3}{R}` 3/4 red creature (Ogre Knight).
//! "Whenever this creature attacks, another target attacking Knight
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Ogre Errant");
