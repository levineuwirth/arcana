//! Obelisk of Bant — `{3}` artifact (Shards of Alara).
//! "{T}: Add {G}, {W}, or {U}."
//!
//! The three-color mana choice is modeled as THREE mana abilities —
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Obelisk of Bant");
