//! Jund Battlemage — `{2}{R}` 2/2 Human Shaman.
//! "{B}, {T}: Target player loses 1 life. {G}, {T}: Create a 1/1 green
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Jund Battlemage");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{G}, {T}: Create a 1/1 green Saproling creature token.".into(),
                cost: ActivationCost {
