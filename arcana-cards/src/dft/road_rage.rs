...
//! creature or planeswalker, where X is 2 plus the number of Mounts and
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    ...
    reg.register(
        CardDefinition::new(name, chars).with_spell_ability(SpellAbilityDef {
            text: "Road Rage deals X damage to target creature or \
                   planeswalker, where X is 2 plus the number of Mounts \
