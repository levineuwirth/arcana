...
fn resolve(
    ...
    vec![
        Effect::TutorToBattlefield { player: entry.controller, filter: land_filter.clone(), tapped: false },
        Effect::TutorToBattlefield { player: entry.controller, filter: land_filter, tapped: false },
    ]
}
