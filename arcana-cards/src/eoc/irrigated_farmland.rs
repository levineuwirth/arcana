//! Irrigated Farmland — nonbasic land, subtypes Plains Island.
//! "({T}: Add {W} or {U}.)" (intrinsic to the basic land types,
//! wired explicitly here), "This land enters tapped.", and
//! "Cycling {2}". The cycling keyword synthesizes its own
//! "[cost], discard this card: draw a card" activation.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Irrigated Farmland");
