//! Bonecaller Cleric — `{1}{B}` 2/1 black Human Cleric.
//! "{3}{B}, Sacrifice this creature: Return target creature card from your graveyard
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Bonecaller Cleric");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{3}{B}, Sacrifice this creature: Return target creature card from your graveyard to the battlefield.".into(),
                cost: ActivationCost {
