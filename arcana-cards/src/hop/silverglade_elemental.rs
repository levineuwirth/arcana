//! Silverglade Elemental — `{4}{G}` 4/4 green Creature — Elemental.
//! "When this creature enters, you may search your library for a Forest card,
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Silverglade Elemental");
