//! Tar Pitcher — `{3}{R}` 2/2 red Goblin Shaman. "{T}, Sacrifice a Goblin: This
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Tar Pitcher");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{T}, Sacrifice a Goblin: This creature deals 2 damage to any target.".into(),
...
fn deal_two_any_target(
    ...
    // GAP: "Sacrifice a Goblin" activation cost not expressible.
