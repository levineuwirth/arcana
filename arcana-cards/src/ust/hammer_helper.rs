...
//! until end of turn. Untap that creature and roll a six-sided die. Until
//! end of turn, it gains haste and gets +X/+0, where X is the result."
//!
//! # GAP: gain control of a creature until end of turn not in Effect catalog.
//! # GAP: roll a die for variable pump not expressible.
//! Emitting Untap and Haste grant as partial approximation.
...
fn resolve(
    ...
    // GAP: roll a six-sided die for variable +X/+0 not expressible
    vec![
