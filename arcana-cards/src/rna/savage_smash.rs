//! Savage Smash — `{1}{R}{G}` sorcery, "Target creature you control gets
//! +2/+2 until end of turn. Then it fights target creature you don't control."
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_spell_ability(SpellAbilityDef {
                text: "Target creature you control gets +2/+2 until end of turn. Then it fights target creature you don't control.".into(),
...
fn resolve(
    ...
    let TargetChoice::Object(id_b) = second else { return Vec::new(); };
    vec![
        Effect::Pump {
            target: *id_a,
            power: 2,
