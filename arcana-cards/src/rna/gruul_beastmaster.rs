//! Gruul Beastmaster — `{3}{G}` 2/2 Human Shaman with Riot.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Gruul Beastmaster");
...
fn pump_other(state: &GameState, trig: &PendingTrigger, _reg: &CardRegistry) -> Vec<Effect> {
