//! Claustrophobia — `{1}{U}{U}` enchantment — Aura.
//! "Enchant creature. When this Aura enters, tap enchanted creature.
//!  Enchanted creature doesn't untap during its controller's untap step."
//!
//! The ETB taps the host (reached via `source.attached_to`) and installs
//! `attached_dont_untap`, which follows the host and lifts when the Aura
//! leaves.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Claustrophobia");
