//! Surrakar Banisher — `{4}{U}` 3/3 blue Surrakar.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Surrakar Banisher");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_triggered_ability(TriggeredAbilityDef {
            ...
            intervening_if: None,
            effect: etb_bounce_tapped_creature,
