//! Capashen Unicorn — `{1}{W}` 1/2 white Unicorn.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Capashen Unicorn");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{W}, {T}, Sacrifice this creature: Destroy target artifact or enchantment.".into(),
                cost: ActivationCost {
