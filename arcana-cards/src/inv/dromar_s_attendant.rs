//! Dromar's Attendant — `{5}` 3/3 colorless Artifact Creature — Golem.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Dromar's Attendant");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}, Sacrifice this creature: Add {W}{U}{B}.".into(),
                cost: ActivationCost {
