//! Stalking Assassin — `{1}{U}{B}` 1/1 Human Assassin.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Stalking Assassin");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{3}{U}, {T}: Tap target creature.".into(),
                cost: ActivationCost {
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{3}{B}, {T}: Destroy target tapped creature.".into(),
                cost: ActivationCost {
