//! Trench Wurm — `{3}{B}` 3/3 black Creature — Wurm.
//! "{2}{R}, {T}: Destroy target nonbasic land." A tap + mana activated
//! ability that destroys a target nonbasic land (a land lacking the
//! Basic supertype).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Trench Wurm");
