...
//! "that's attacking you" enforced via `ObjectFilter::attacking_you_only()`.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Hunting Kavu");
...
fn exile_target_creature(
    ...
    // This card exiles itself via the sacrifice cost; only exile the target here.
