//! Creeping Tar Pit — Worldwake-style creature-land. "This land enters tapped." Taps for
//! its colors, and "{1}{U}{B}: until end of turn this land becomes a 3/2
//! creature. It's still a land." ("can't be blocked this turn" is GAP'd.) Animation reuses the
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Creeping Tar Pit");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{U}{B}: This land becomes a 3/2 creature until end of turn.".into(),
                cost: ActivationCost {
...
fn animate(_s: &GameState, ctx: &ActivationContext, _r: &CardRegistry) -> Vec<Effect> {
    vec![
        ...
        Effect::InstallContinuousEffect { effect: ContinuousEffect::set_pt(ctx.source, ctx.source, 3, 2, Duration::EndOfTurn) },
    ]
}
