//! Titanium Golem — `{5}` 3/3 colorless Artifact Creature — Golem.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Titanium Golem");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{W}: This creature gains first strike until end of turn.".into(),
                cost: ActivationCost {
