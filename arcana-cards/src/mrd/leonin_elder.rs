//! Leonin Elder — `{W}` 1/1 Creature — Cat Cleric.
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_triggered_ability(TriggeredAbilityDef {
                ...
                filter: ObjectFilter { types_any: Some(TypeLine::ARTIFACT.into()), ..Default::default() },
                from: None,
                to: Zone::Battlefield,
            },
                intervening_if: None,
                effect: leonin_elder_trigger,
