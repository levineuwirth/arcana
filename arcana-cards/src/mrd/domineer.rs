//! Domineer — `{1}{U}{U}` enchantment — Aura.
...
//! we revert control to the host's owner. The "enchant artifact creature"
//! restriction is approximated by enchant creature (the caster's choice
//! honors it in practice).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Domineer");
    ...
    reg.register(
        // NOTE: "enchant artifact creature" approximated by enchant creature
