//! Dawnbringer Charioteers — `{2}{W}{W}` 2/4 Human Soldier.
//!
//! * Flying, lifelink.
//! * Heroic — Whenever you cast a spell that targets this creature, put a
//!   +1/+1 counter on this creature.
//!
//! All wired: Flying/Lifelink as base keywords, Heroic via SelfBecomesTarget
//! with caster: You (matches spells you cast that target it).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Dawnbringer Charioteers");
