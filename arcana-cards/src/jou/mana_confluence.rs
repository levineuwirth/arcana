//! Mana Confluence — nonbasic land (Journey into Nyx, 2014).
//! "{T}, Pay 1 life: Add one mana of any color." Modeled as five
//! mana abilities, one per WUBRG color, each costing tap + 1 life —
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Mana Confluence");
