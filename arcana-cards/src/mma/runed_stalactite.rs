...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Runed Stalactite");
...
/// ETB trigger: install the layer "equipped creature gets +1/+1"
...
fn etb_install_attached_pump(
    ...
    // GAP: "equipped creature ... is every creature type" — attached_pt covers
    // P/T only (no attached type/subtype grant for the changeling half).
