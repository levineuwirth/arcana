//! Take Possession — `{5}{U}{U}` enchantment — Aura.
...
//! GAP: Split second (outside the usable keyword surface — no keyword emitted).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Take Possession");
