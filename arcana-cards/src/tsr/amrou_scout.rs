//! Amrou Scout — `{1}{W}` 2/1 white Kithkin Rebel Scout.
//! "{4}, {T}: Search your library for a Rebel permanent card with mana
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Amrou Scout");
...
fn rebel_tutor(
    ...
    let rebel_filter = arcana_core::script::subtype_filter(reg, "Rebel").with_max_cmc(3);
