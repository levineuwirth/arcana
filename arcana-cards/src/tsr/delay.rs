...
//! gains suspend."
//!
//! GAP: exile-with-time-counters-instead-of-graveyard and Suspend grant
//! not expressible; expressed as hard counter.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Delay");
...
fn resolve(
    ...
    // GAP: exile-with-time-counters and Suspend grant not expressible
