//! Bane Alley Blackguard — vanilla 1/3 black creature for `{1}{B}`. No
//! abilities; pure stats as a Human Rogue.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Bane Alley Blackguard");
