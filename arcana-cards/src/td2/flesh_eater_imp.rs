//! Flesh-Eater Imp — `{3}{B}` 2/2 Phyrexian Imp.
//! Flying. Infect.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Flesh-Eater Imp");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "Sacrifice a creature: This creature gets +1/+1 until end of turn.".into(),
                cost: ActivationCost {
