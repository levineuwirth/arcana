//! Threaten — `{2}{R}` sorcery, "Untap target creature and gain control of
//! it until end of turn. That creature gains haste until end of turn."
//! GAP: temporary control effect (gain control until end of turn) is not
