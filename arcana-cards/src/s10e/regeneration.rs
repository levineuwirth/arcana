...
//!
//! Pure host-activated Aura. The ETB installs a single `attached_activated`
//! ability ("{G}: Regenerate") whose cost and Regenerate effect run against
//! the HOST (`ctx.source`).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Regeneration");
