//! Rootwater Commando — `{2}{U}` 2/2 Merfolk with Islandwalk.
//! Nemesis common; a blue merfolk that can't be blocked as long
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Rootwater Commando");
