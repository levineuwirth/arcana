//! Persuasion — `{3}{U}{U}` enchantment — Aura.
//! "Enchant creature. You control enchanted creature."
//!
//! Control-change Aura (Control Magic / Mind Control class). On ETB (id 1)
//! the engine has already attached the Aura, so the host is
//! `source.attached_to`; we `ChangeControl` it to the Aura's controller.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Persuasion");
