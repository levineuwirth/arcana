//! Composite Golem — `{6}` 4/4 colorless Artifact Creature — Golem. "Sacrifice
//! this creature: Add {W}{U}{B}{R}{G}."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Composite Golem");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "Sacrifice this creature: Add {W}{U}{B}{R}{G}.".into(),
                cost: ActivationCost {
                    sacrifice: true,
