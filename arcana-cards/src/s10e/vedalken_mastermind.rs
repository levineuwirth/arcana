//! Vedalken Mastermind — `{U}{U}` 1/2 blue Vedalken Wizard.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Vedalken Mastermind");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{U}, {T}: Return target permanent you control to its owner's hand.".into(),
                cost: ActivationCost {
