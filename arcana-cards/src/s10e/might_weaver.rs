//! Might Weaver — `{1}{G}` 2/1 green Human Wizard.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Might Weaver");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}: Target red or white creature gains trample until end of turn.".into(),
                cost: ActivationCost {
