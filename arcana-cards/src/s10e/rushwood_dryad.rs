//! Rushwood Dryad — `{1}{G}` 2/1 Dryad with Forestwalk.
//! Mercadian Masques common; an efficient early green beater
//! that punishes Forest-heavy opponents.
//!
//! # Rules references
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Rushwood Dryad");
