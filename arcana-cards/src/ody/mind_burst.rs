//! Mind Burst — `{1}{B}` sorcery.
//! "Target player discards X cards, where X is one plus the number of cards named Mind Burst in all graveyards."
//! GAP: counting cards with a specific name across all graveyards is not expressible with the script helpers.
//! Best effort: target player discards 1 card.
...
fn resolve(
    ...
    // GAP: counting named cards across all graveyards is not expressible
