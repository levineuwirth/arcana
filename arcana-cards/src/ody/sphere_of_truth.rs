//! Sphere of Truth — `{3}{W}` enchantment. "If a white source would
//! deal damage to you, prevent 2 of that damage."
//!
//! Implementation: an ETB trigger installs a
//! `ReplacementCondition::WouldDealDamage` replacement scoped to white
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sphere of Truth");
...
/// ETB trigger: install "if a white source would deal damage to you,
    ...
    vec![Effect::InstallReplacementEffect {
        effect: Box::new(ReplacementEffect {
            ...
            condition: ReplacementCondition::WouldDealDamage {
                source_filter: ObjectFilter::default().with_colors(ColorSet::white()),
