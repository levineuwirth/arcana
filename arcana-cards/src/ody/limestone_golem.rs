//! Limestone Golem — `{6}` 3/4 colorless Artifact Creature — Golem.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Limestone Golem");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}, Sacrifice this creature: Target player draws a card.".into(),
                cost: ActivationCost {
