//! Sphere of Law — `{3}{W}` enchantment. "If a red source would deal
//! damage to you, prevent 2 of that damage."
//!
//! Implementation: an ETB trigger installs a
//! `ReplacementCondition::WouldDealDamage` replacement scoped to red
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sphere of Law");
...
/// ETB trigger: install "if a red source would deal damage to you,
    ...
    vec![Effect::InstallReplacementEffect {
        effect: Box::new(ReplacementEffect {
            ...
            condition: ReplacementCondition::WouldDealDamage {
                source_filter: ObjectFilter::default().with_colors(ColorSet::red()),
