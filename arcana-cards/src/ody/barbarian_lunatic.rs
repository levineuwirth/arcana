//! Barbarian Lunatic — `{2}{R}` 2/1 Human Barbarian.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Barbarian Lunatic");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}{R}, Sacrifice this creature: It deals 2 damage to target creature.".into(),
                cost: ActivationCost {
