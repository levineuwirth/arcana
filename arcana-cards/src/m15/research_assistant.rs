//! Research Assistant — `{1}{U}` 1/3 blue Human Wizard. "{3}{U}, {T}: Draw a
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Research Assistant");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{3}{U}, {T}: Draw a card, then discard a card.".into(),
                cost: ActivationCost {
