//! Eyeblight Cullers — `{4}{B}` 3/3 black creature. "When this creature dies,
//! create three 1/1 green Elf Warrior creature tokens, then mill three cards."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Eyeblight Cullers");
