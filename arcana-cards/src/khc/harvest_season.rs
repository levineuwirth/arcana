...
//!
//! # GAP: dynamic X based on tapped creature count; TutorToBattlefield
//! finds one card. Emitting a single TutorToBattlefield as approximation.
...
fn resolve(
    ...
    // GAP: dynamic X (number of tapped creatures controlled); multi-card tutor not supported
