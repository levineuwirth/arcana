...
//! 2 damage to any target. You get a one-time boon with [...]."
//!
//! GAP: one-time boon / play-from-exile-while-active mechanic not
//! modeled; emit the damage only.
...
fn resolve(
    ...
    // GAP: one-time boon side-effect not modeled.
