//! Tibalt's Rager — `{1}{R}` 1/2 red Devil.
//! "When this creature dies, it deals 1 damage to any target." plus
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Tibalt's Rager");
