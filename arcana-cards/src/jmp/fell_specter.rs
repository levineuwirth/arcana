//! Fell Specter — `{3}{B}` 1/3 Specter with Flying.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Fell Specter");
...
fn opponent_loses_two(
    ...
    // 2-player read: the discarding opponent is the controller's opponent.
