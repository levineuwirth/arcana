...
//! instead."
//
// GAP: "if that creature is attacking, you may put it on top of library instead"
// requires checking whether the target is attacking + a player may-choice
// between two effects. The base bounce is expressible; the conditional
// may-to-library branch is not.
...
fn resolve(
    ...
    vec![
        ...
        // GAP: conditional "if attacking, may put on top of library instead" not expressible
    ]
}
