//! Borderland Minotaur — vanilla 4/3 red creature for `{2}{R}{R}`. No
//! abilities; pure stats. A Minotaur Warrior from Magic 2013.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Borderland Minotaur");
