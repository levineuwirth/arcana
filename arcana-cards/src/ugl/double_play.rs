...
fn resolve(
    ...
    // The "next game" delayed effect has no representation; emit only the immediate basic-land tutor.
    // GAP: "at the beginning of the first upkeep in your next game" cross-game delayed effect not modeled.
