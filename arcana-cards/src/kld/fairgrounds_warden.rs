//! Fairgrounds Warden — `{2}{W}` 1/3 white Dwarf Soldier creature.
//! "When this creature enters, exile target creature an opponent controls until this creature
//! leaves the battlefield."
//! GAP: effect — "until this creature leaves the battlefield" conditional return is not
//! expressible; emitting ExilePermanent only (the return-on-leave is dropped).
