//! Torch Gauntlet — `{2}` artifact — Equipment.
//! "Equipped creature gets +2/+0. Equip {2}."
//! Mirrors the Bonesplitter pattern: `with_equip` wires the canonical
//! Equip activation; an ETB trigger installs the dynamic
//! "attached creature gets +2/+0" continuous effect.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Torch Gauntlet");
