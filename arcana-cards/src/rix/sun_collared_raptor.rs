//! Sun-Collared Raptor — `{1}{R}` 1/2 Dinosaur with Trample.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sun-Collared Raptor");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{2}{R}: This creature gets +3/+0 until end of turn.".into(),
            cost: ActivationCost {
