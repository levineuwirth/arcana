//! Sarevok, Mighty Usurper — `{3}{B}{G}` Legendary 4/4 Human Knight with Trample.
//!
//! Oracle:
//! * Trample.
//! * At the beginning of combat on your turn, target creature you control gains
//!   trample and gets +X/+0 until end of turn, where X is the number of creature
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sarevok, Mighty Usurper");
