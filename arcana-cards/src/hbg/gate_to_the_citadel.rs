//! Gate to the Citadel — nonbasic land — Plains Gate.
//! "({T}: Add {W}.)" / "Gate to the Citadel enters the battlefield
//! tapped." / "{3}{W}, {T}: Seek a nonland card. Activate only once."
//! Enters tapped + a white mana ability. GAP: "Seek" is an
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Gate to the Citadel");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{3}{W}, {T}: Seek a nonland card. Activate only once.".into(),
                cost: ActivationCost {
