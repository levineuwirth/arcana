//! Hag of Syphoned Breath — `{2}{B}` 2/2 Hag Warlock.
//! "At the beginning of your upkeep, each opponent loses 2 life and
//! you gain 2 life."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Hag of Syphoned Breath");
