//! A-Mr. Orfeo, the Boulder — `{1}{B}{R}{G}` 3/4 black/red/green Legendary Rhino Warrior.
//! "Whenever you attack, double target creature's power until end of turn."
//!
//! GAP: no "double power" effect in the catalog. Using script::power_of and Pump as
//! the closest approximation (adds power equal to current power = doubles it).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("A-Mr. Orfeo, the Boulder");
