//! Xander's Lounge — nonbasic land — Island Swamp Mountain.
//! "({T}: Add {U}, {B}, or {R}.)" "This land enters tapped." and
//! "Cycling {3}."
//! Enters-tapped tri-land: three mana abilities (one per color, the
//! catalog color-choice idiom) plus the Cycling keyword (the engine
//! synthesizes the cycling activation).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Xander's Lounge");
