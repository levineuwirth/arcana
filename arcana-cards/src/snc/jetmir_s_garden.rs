...
//! "({T}: Add {R}, {G}, or {W}.)" — intrinsic to its basic land
//! subtypes, wired as three mana abilities. "This land enters tapped."
//! and "Cycling {3}".
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Jetmir's Garden");
