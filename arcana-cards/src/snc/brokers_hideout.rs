//! Brokers Hideout — nonbasic land. "When this land enters, sacrifice
//! it. When you do, search your library for a basic Forest, Plains, or
//! Island card, put it onto the battlefield tapped, then shuffle and
//! you gain 1 life."
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Brokers Hideout");
...
fn etb_sac_and_fetch(
    ...
    let nm = reg.interner().lookup("Brokers Hideout");
