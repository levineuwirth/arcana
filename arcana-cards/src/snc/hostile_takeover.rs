...
//! creature has base power and toughness 1/1 until end of turn. Up to
//! one other target creature has base power and toughness 4/4 until
//! end of turn. Then Hostile Takeover deals 3 damage to each creature."
