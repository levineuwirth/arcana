//! Zodiac Tiger — `{2}{G}{G}` 3/4 Cat with Forestwalk.
//! Portal: Three Kingdoms uncommon; a green cat that can't be
//! blocked as long as the defending player controls a Forest.
//!
//! # Rules references
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Zodiac Tiger");
