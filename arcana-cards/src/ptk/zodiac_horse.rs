//! Zodiac Horse — `{3}{G}` 3/3 Horse with Islandwalk.
//! Portal Three Kingdoms common; part of the Zodiac cycle. This green
//! Horse threatens blue-mana Island-controlling opponents.
//!
//! # Rules references
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Zodiac Horse");
