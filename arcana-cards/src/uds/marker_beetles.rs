//! Marker Beetles — `{1}{G}{G}` 2/3 Insect.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Marker Beetles");
...
fn dies_pump(_state: &GameState, trig: &PendingTrigger, _reg: &CardRegistry) -> Vec<Effect> {
