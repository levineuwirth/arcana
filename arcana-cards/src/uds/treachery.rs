...
//! "Enchant creature. When this Aura enters, untap up to five lands.
...
//! `ChangeControl` it to the Aura's controller. When the Aura leaves
//! (id 2) we revert control to the host's owner. The "untap up to five
//! lands" ETB rider stays GAP'd (optional choose-up-to-N untap of lands has
//! no expressible effect here).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Treachery");
...
fn etb_gain_control(
    ...
    // GAP: "untap up to five lands" ETB rider (optional choose-up-to-N untap).
