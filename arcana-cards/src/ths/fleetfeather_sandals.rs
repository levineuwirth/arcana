...
//! The Equip half is wired via `with_equip`; the flying and haste
...
/// ETB trigger: install the "equipped creature has flying and haste"
/// keyword grants, following the attachment dynamically.
