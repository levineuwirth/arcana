//! Traveling Philosopher — vanilla 2/2 white creature for `{1}{W}`. A
//! Human Advisor with no abilities, pure stats.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Traveling Philosopher");
