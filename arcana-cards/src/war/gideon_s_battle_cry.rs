//! Gideon's Battle Cry — `{2}{W}{W}` sorcery.
//! "Put a +1/+1 counter on each creature you control. You may search your
//! library and/or graveyard for a card named Gideon, the Oathsworn, reveal
//! it, and put it into your hand. If you search your library this way, shuffle."
//! GAP: No engine effect for 'search library and/or graveyard for a named card'.
...
fn resolve(
    ...
    let mut effects: Vec<Effect> = ids
        ...
        .collect();
    // GAP: no 'search library and/or graveyard for named card' effect
    effects
}
