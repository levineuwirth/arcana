//! Vizier of the Scorpion — `{2}{B}` 1/1 black Zombie Wizard.
//!
//! * When this creature enters, amass Zombies 1.
//! * Zombie tokens you control have deathtouch. (Static anthem — GAP.)
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Vizier of the Scorpion");
    ...
    // GAP: static "Zombie tokens you control have deathtouch" is a continuous
