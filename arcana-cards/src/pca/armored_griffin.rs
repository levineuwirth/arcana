//! Armored Griffin — `{3}{W}` 2/3 Griffin with Flying and Vigilance.
//! A defensive white Griffin combining evasion and untapped blocking.
//!
//! # Rules references
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Armored Griffin");
