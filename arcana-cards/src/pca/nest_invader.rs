//! Nest Invader — `{1}{G}` 2/2 Eldrazi Drone.
//! "When this creature enters, create a 0/1 colorless Eldrazi Spawn
//! creature token. It has 'Sacrifice this token: Add {C}.'"
//!
//! The Eldrazi Spawn token's activated ability (sac for {C}) is
//! recognized by its subtype in the engine; emit the token cleanly.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Nest Invader");
