//! Boreal Griffin — `{3}{W}{W}` 3/2 Snow Creature — Griffin.
//!
//! Flying.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Boreal Griffin");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{S}: This creature gains first strike until end of turn.".into(),
            cost: ActivationCost {
