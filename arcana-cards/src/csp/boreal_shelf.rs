//! Boreal Shelf — snow land (Coldsnap, 2006).
//! "This land enters tapped." and "{T}: Add {W} or {U}."
//! The snow tapland archetype: `SupertypeSet::SNOW`,
//! `EntersWithSpec::Tapped`, and the two-color mana choice modeled as
//! two separate mana abilities.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Boreal Shelf");
