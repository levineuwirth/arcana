//! Frost Raptor — `{2}{U}` 2/2 Snow Creature — Bird with Flying.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Frost Raptor");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{S}{S}: This creature gains shroud until end of turn.".into(),
            cost: ActivationCost {
