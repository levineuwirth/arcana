//! Lightning Serpent — `{X}{R}` 2/1 Elemental Serpent.
//!
//! * Trample, haste.
//! * This creature enters with X +1/+0 counters on it. (GAP — there is
//!   no +1/+0 counter kind, and X-on-enter counter placement is not
//!   modeled.)
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Lightning Serpent");
