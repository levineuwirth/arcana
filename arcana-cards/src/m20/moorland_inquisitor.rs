//! Moorland Inquisitor — `{1}{W}` 2/2 Human Soldier.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Moorland Inquisitor");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}{W}: This creature gains first strike until end of turn.".into(),
                cost: ActivationCost {
