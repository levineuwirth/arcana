//! Feral Abomination — `{5}{B}` 5/5 Thrull with Deathtouch.
//! A large black thrull that destroys any creature it damages,
//! no matter how little damage it deals.
//!
//! # Rules references
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Feral Abomination");
