//! Jund Panorama — nonbasic land. "{T}: Add {C}." and "{1}, {T},
//! Sacrifice this land: Search your library for a basic Swamp,
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Jund Panorama");
        ...
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}, {T}, Sacrifice this land: Search your library \
                       for a basic Swamp, Mountain, or Forest card, put it \
...
fn fetch_basic(
    ...
    for n in ["Swamp", "Mountain", "Forest"] {
