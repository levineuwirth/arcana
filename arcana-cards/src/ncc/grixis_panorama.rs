...
//!
//! The fetch is an [`Effect::TutorToBattlefield`] with `tapped: true`
//! over basic lands with any of the Island / Swamp / Mountain
//! subtypes.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Grixis Panorama");
...
fn fetch_basic(
    ...
    let subtypes: Vec<_> = ["Island", "Swamp", "Mountain"]
        .into_iter()
