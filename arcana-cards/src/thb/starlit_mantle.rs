//! Starlit Mantle — `{1}{U}` enchantment — Aura.
//! "Flash. Enchant creature you control. When this Aura enters, enchanted
//!  creature gains hexproof until end of turn. Enchanted creature gets +1/+1."
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Starlit Mantle");
