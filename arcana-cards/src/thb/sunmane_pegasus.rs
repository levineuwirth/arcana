//! Sunmane Pegasus — `{3}{W}` 2/3 Pegasus with Flying.
//!
//! Oracle:
//! * Flying.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sunmane Pegasus");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{W}: This creature gains vigilance and lifelink until end of turn.".into(),
                cost: ActivationCost {
                ...
                face_gate: None,
                effect: gain_vigilance_lifelink,
            }),
    )
}

fn gain_vigilance_lifelink(
    _state: &GameState,
