//! Scavenging Harpy — `{2}{B}` 2/1 Harpy with Flying.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Scavenging Harpy");
...
fn exile_card_from_opp_gy(_state: &GameState, trig: &PendingTrigger, _reg: &CardRegistry) -> Vec<Effect> {
