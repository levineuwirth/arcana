//! Thorn Lieutenant — `{1}{G}` 2/3 green Elf Warrior.
//!
//! Whenever this creature becomes the target of a spell or ability an
//! opponent controls, create a 1/1 green Elf Warrior creature token.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Thorn Lieutenant");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_triggered_ability(TriggeredAbilityDef {
                ...
                intervening_if: None,
                effect: make_elf_warrior_token,
                trigger_zones: vec![Zone::Battlefield],
                frequency: TriggerFrequency::EachTime,
                target_requirements: Vec::new(),
            })
            .with_activated_ability(ActivatedAbilityDef {
                text: "{5}{G}: This creature gets +4/+4 until end of turn.".into(),
                cost: ActivationCost {
