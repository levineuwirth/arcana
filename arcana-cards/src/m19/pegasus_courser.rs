//! Pegasus Courser — `{2}{W}` 1/3 Pegasus with Flying.
//! "Whenever this creature attacks, another target attacking creature
//! gains flying until end of turn."
//!
//! (The "another" self-exclusion is a fidelity nuance the target filter
//! does not encode.)
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Pegasus Courser");
