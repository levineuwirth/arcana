//! Radiating Lightning — `{3}{R}` instant, "Radiating Lightning deals
//! 3 damage to target player and 1 damage to each creature that player
//! controls."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    ...
    reg.register(
        CardDefinition::new(name, chars).with_spell_ability(SpellAbilityDef {
            text: "Radiating Lightning deals 3 damage to target player and \
