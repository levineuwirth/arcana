//! Explosive Apparatus — `{1}` artifact (Innistrad: Midnight Hunt,
//! 2021). "{3}, {T}, Sacrifice this artifact: It deals 2 damage to
//! any target."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Explosive Apparatus");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(
            ActivatedAbilityDef {
                text: "{3}, {T}, Sacrifice this artifact: It deals 2 damage \
                       to any target."
                    .into(),
                cost: ActivationCost {
