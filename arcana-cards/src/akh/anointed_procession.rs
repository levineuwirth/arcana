//! Anointed Procession — `{3}{W}` enchantment. "If an effect would
//! create one or more tokens under your control, it creates twice
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Anointed Procession");
