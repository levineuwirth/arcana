//! Hypervolt Grasp — `{2}{R}` enchantment — Aura.
//! "Enchant creature. Enchanted creature has '{T}: This creature deals
//!  1 damage to any target.' {1}{U}: Return this Aura to its owner's
//!  hand."
//!
//! Host-activated Aura. The ETB installs an `attached_activated`
//! continuous effect granting the host '{T}: deal 1 damage to any
//! target' (cost + effect run against the host). The Aura also has its
//! own '{1}{U}: return this Aura to its owner's hand' activated ability.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Hypervolt Grasp");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{U}: Return this Aura to its owner's hand.".into(),
                cost: ActivationCost {
