//! Offering to Asha — `{2}{W}{U}` instant. "Counter target spell
//! unless its controller pays {4}. You gain 4 life."
...
fn resolve(
    ...
    vec![
        Effect::CounterUnlessPays { target: stack_id, cost: ManaCost::parse("{4}").expect("valid cost") },
