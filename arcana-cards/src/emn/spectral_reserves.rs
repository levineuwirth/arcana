//! Spectral Reserves — `{3}{W}` sorcery. "Create two 1/1 white Spirit
//! creature tokens with flying. You gain 2 life."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Spectral Reserves");
