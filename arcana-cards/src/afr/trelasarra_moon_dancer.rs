//! Trelasarra, Moon Dancer — `{G}{W}` 2/2 legendary green/white Elf Cleric
//! creature. "Whenever you gain life, put a +1/+1 counter on Trelasarra and
//! scry 1."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Trelasarra, Moon Dancer");
