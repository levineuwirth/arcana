//! Owlbear — `{3}{G}{G}` 4/4 green Bird Bear.
//!
//! Trample.
//! Keen Senses — When this creature enters, draw a card.
//!
//! Two abilities: the Trample keyword (base characteristic) plus an
//! ETB triggered ability that draws a card (Elvish Visionary pattern).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Owlbear");
