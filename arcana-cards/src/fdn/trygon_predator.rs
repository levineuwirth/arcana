//! Trygon Predator — `{1}{G}{U}` 2/3 Beast with Flying.
//!
//! * Flying (keyword).
//! * Whenever this creature deals combat damage to a player, you may destroy
//!   target artifact or enchantment that player controls. (The "that player
//!   controls" restriction and the "may" are fidelity gaps — any artifact or
//!   enchantment is a legal target.)
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Trygon Predator");
