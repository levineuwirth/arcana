//! Orzhov Guildgate — nonbasic land, subtype Gate.
//! "This land enters tapped." and "{T}: Add {W} or {B}." The tapland
//! archetype: `EntersWithSpec::Tapped` plus a two-color mana choice
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Orzhov Guildgate");
