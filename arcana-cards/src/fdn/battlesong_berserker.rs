//! Battlesong Berserker — `{3}{R}` 3/4 red Creature — Human Berserker.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Battlesong Berserker");
