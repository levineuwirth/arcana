//! Voracious Greatshark — `{3}{U}{U}` 5/4 Creature — Shark with Flash.
//! "When this creature enters, counter target artifact or creature spell."
//!
//! Flash is a base keyword. The ETB trigger counters a target artifact or
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Voracious Greatshark");
