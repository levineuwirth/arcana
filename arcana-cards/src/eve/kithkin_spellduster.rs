//! Kithkin Spellduster — `{4}{W}` 2/3 Kithkin Wizard with Flying and Persist.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Kithkin Spellduster");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{W}, Sacrifice this creature: Destroy target enchantment.".into(),
                cost: ActivationCost {
