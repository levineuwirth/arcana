//! Fang Skulkin — `{2}` 2/1 colorless Artifact Creature — Scarecrow.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Fang Skulkin");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}: Target black creature gains wither until end of turn.".into(),
                cost: ActivationCost {
