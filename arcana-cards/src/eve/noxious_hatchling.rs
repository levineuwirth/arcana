//! Noxious Hatchling — `{3}{B/G}` 6/6 Elemental (black/green).
//! "This creature enters with four -1/-1 counters on it." — GAP: no
//!  enters-with-counters primitive in the available surface.
//! Wither.
//! - "Whenever you cast a black spell, remove a -1/-1 counter from this
//!   creature."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Noxious Hatchling");
