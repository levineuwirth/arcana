//! Jawbone Skulkin — `{1}` 1/1 colorless Artifact Creature — Scarecrow.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Jawbone Skulkin");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}: Target red creature gains haste until end of turn.".into(),
                cost: ActivationCost {
