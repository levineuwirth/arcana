//! Shell Skulkin — `{4}` 3/2 colorless Artifact Creature — Scarecrow.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Shell Skulkin");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{3}: Target blue creature gains shroud until end of turn.".into(),
                cost: ActivationCost {
