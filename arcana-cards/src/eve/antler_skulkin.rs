//! Antler Skulkin — `{5}` 3/3 colorless Artifact Creature — Scarecrow.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Antler Skulkin");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}: Target white creature gains persist until end of turn.".into(),
                cost: ActivationCost {
