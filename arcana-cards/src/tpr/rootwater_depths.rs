//! Rootwater Depths — nonbasic land (Tempest karoo-pain cycle).
//! "{T}: Add {C}." and "{T}: Add {U} or {B}. This land doesn't untap
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Rootwater Depths");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{T}: Add {B}. This land doesn't untap during your \
                       next untap step."
                    .into(),
                cost: ActivationCost::tap_only(),
                target_requirements: Vec::new(),
