//! Fighting Drake — `{2}{U}{U}` 2/4 Drake with Flying.
//! A mono-blue flier with above-average toughness for its cost;
//! a sturdy aerial blocker.
//!
//! # Rules references
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Fighting Drake");
