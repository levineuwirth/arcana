//! Spitting Hydra — `{3}{R}{R}` 0/0 red Hydra.
//!
//! * Enters with four +1/+1 counters (modeled as an ETB trigger that adds the
//!   counters to itself).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Spitting Hydra");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{R}, Remove a +1/+1 counter from this creature: It deals 1 damage to target creature.".into(),
                cost: ActivationCost {
