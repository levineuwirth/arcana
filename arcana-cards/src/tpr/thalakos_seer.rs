//! Thalakos Seer — `{U}{U}` 1/1 Thalakos Wizard with Shadow.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Thalakos Seer");
...
fn ltb_draw(_state: &GameState, trig: &PendingTrigger, _reg: &CardRegistry) -> Vec<Effect> {
