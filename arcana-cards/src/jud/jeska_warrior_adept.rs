//! Jeska, Warrior Adept — `{2}{R}{R}` 3/1 Legendary Human Barbarian Warrior.
//!
//! * First strike, haste.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Jeska, Warrior Adept");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{T}: Jeska, Warrior Adept deals 1 damage to any target.".into(),
            cost: ActivationCost {
                tap: true,
