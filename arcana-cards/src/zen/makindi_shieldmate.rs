//! Makindi Shieldmate — `{2}{W}` 0/3 Kor Soldier Ally.
//! "Defender
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Makindi Shieldmate");
...
fn add_counter(
    ...
    // "you may put a +1/+1 counter on this creature" — the optional grant
    // is modeled as the counter placement.
