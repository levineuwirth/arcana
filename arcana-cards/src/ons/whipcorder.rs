//! Whipcorder — `{W}{W}` 2/2 Human Soldier Rebel.
//! {W}, {T}: Tap target creature.
//! Morph {W}. (Morph is not a usable KeywordAbility — GAP'd.)
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Whipcorder");
    ...
    let chars = Characteristics {
        ...
        // GAP: Morph {W} — Morph is not a usable KeywordAbility.
        keywords: vec![],
        ..Default::default()
    };
