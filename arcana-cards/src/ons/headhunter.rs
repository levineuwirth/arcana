//! Headhunter — `{1}{B}` 1/1 Human Cleric.
//! "Whenever this creature deals combat damage to a player, that player
//! discards a card."
//! "Morph {B}."
//!
//! Morph is not an available KeywordAbility variant, so it is GAP'd. The
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Headhunter");
    ...
    // GAP: Morph {B} — not an available KeywordAbility variant.
    reg.register(
