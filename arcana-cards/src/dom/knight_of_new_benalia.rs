//! Knight of New Benalia — vanilla 3/1 white creature for `{1}{W}`. A
//! Human Knight with no abilities, pure stats.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Knight of New Benalia");
