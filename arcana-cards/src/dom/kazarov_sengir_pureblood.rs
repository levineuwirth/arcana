//! Kazarov, Sengir Pureblood — `{5}{B}{B}` 4/4 Legendary Vampire with Flying.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Kazarov, Sengir Pureblood");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{3}{R}: Kazarov deals 2 damage to target creature.".into(),
                cost: ActivationCost {
