//! Verdant Force — `{5}{G}{G}{G}` 7/7 green Elemental. "At the beginning of
//! each upkeep, create a 1/1 green Saproling creature token."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Verdant Force");
