//! Yavimaya Sapherd — `{2}{G}` 2/2 green Creature — Fungus. "When this
//! creature enters, create a 1/1 green Saproling creature token."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Yavimaya Sapherd");
