//! Zebra Unicorn — `{2}{G}{W}` 2/2 green-white Unicorn. "Whenever this
//! creature deals damage, you gain that much life." Damage-dealt trigger;
//! gain life equal to damage dealt. Amount is dynamic (from trig.damage_amount).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Zebra Unicorn");
