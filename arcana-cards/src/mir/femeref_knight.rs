//! Femeref Knight — `{2}{W}` 2/2 Human Knight with Flanking.
//!
//! "{W}: This creature gains vigilance until end of turn."
//!
//! Flanking is a base keyword. The mana ability grants the source Vigilance
//! until end of turn.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Femeref Knight");
