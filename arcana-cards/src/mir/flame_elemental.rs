//! Flame Elemental — `{2}{R}{R}` 3/2 red Elemental.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Flame Elemental");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{R}, {T}, Sacrifice this creature: It deals damage equal to its power to target creature.".into(),
                cost: ActivationCost {
