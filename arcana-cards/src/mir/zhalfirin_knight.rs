//! Zhalfirin Knight — `{2}{W}` 2/2 Human Knight with Flanking.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Zhalfirin Knight");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{W}{W}: This creature gains first strike until end of turn.".into(),
            cost: ActivationCost {
