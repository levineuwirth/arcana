//! Burning Shield Askari — `{2}{R}` 2/2 Human Knight with Flanking.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Burning Shield Askari");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{R}{R}: This creature gains first strike until end of turn.".into(),
                cost: ActivationCost {
