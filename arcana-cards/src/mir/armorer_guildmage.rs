//! Armorer Guildmage — `{R}` 1/1 Human Wizard.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Armorer Guildmage");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{G}, {T}: Target creature gets +0/+1 until end of turn.".into(),
                cost: ActivationCost {
...
fn pump_power(_state: &GameState, ctx: &ActivationContext, _reg: &CardRegistry) -> Vec<Effect> {
