//! Civic Guildmage — `{W}` 1/1 Human Wizard.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Civic Guildmage");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{U}, {T}: Put target creature you control on top of its owner's library.".into(),
                cost: ActivationCost {
