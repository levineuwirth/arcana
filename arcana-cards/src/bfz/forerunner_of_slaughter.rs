//! Forerunner of Slaughter — `{B}{R}` 3/2 colorless (Devoid) Eldrazi Drone.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Forerunner of Slaughter");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{1}: Target colorless creature gains haste until end of turn.".into(),
            cost: ActivationCost {
