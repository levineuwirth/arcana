...
//! counter on each creature you control. They gain vigilance until
//! end of turn. The Ring tempts you."
//!
//! "The Ring tempts you" has no catalog primitive and is omitted.
...
fn resolve(state: &GameState, entry: &StackEntry, _reg: &CardRegistry) -> Vec<Effect> {
    ...
    // GAP: "The Ring tempts you" is not in the effect catalog.
    vec![
        Effect::ForEach {
            targets: ids.clone(),
