//! Protector of Gondor — `{3}{W}` 3/3 white Creature — Human Soldier.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Protector of Gondor");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_triggered_ability(TriggeredAbilityDef {
                ...
                intervening_if: None,
                effect: etb_create_soldier_token,
