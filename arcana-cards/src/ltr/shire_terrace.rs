//! Shire Terrace — nonbasic land.
//! "{T}: Add {C}." and "{1}, {T}, Sacrifice this land: Search your library
//! for a basic land card, put it onto the battlefield tapped, then
//! shuffle." Mana ability plus a fetch activation
//! (`Effect::TutorToBattlefield`, tapped; shuffle is automatic).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Shire Terrace");
