//! Tale of Tinúviel — `{3}{W}{W}` white Enchantment — Saga.
...
//! GAP: Chapter I "for as long as you control this Saga" — GrantKeyword with WhileSourceOnBattlefield not available in this form; using EndOfTurn as approximation.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Tale of Tinúviel");
...
fn chapter_i(
    ...
    // GAP: "for as long as you control this Saga" — using EndOfTurn as duration approximation
