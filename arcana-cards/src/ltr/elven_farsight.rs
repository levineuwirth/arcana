//! Elven Farsight — `{G}` sorcery. Scry 3; reveal-top creature-cantrip
//! rider is a gap.
...
fn resolve(
    ...
    // GAP: 'reveal the top card; if creature, draw' — no library-top
    // inspection / conditional draw primitive.
