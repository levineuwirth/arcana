//! Lightning Cloud — `{3}{R}` enchantment.
//! "Whenever a player casts a red spell, you may pay {R}. If you do,
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Lightning Cloud");
...
/// "…you may pay {R}. If you do, this enchantment deals 1 damage to any
/// target."
fn pay_and_bolt(
    _state: &GameState,
    trig: &PendingTrigger,
    ...
    vec![Effect::OptionalPayment {
        ...
        cost: OptionalPaymentKind::Mana(
            ManaCost::parse("{R}").expect("valid cost"),
        ),
