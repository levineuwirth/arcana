//! Goblin War Strike — `{R}` sorcery. "Goblin War Strike deals damage
//! to target player or planeswalker equal to the number of Goblins
//! you control."
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_spell_ability(SpellAbilityDef {
                text: "Goblin War Strike deals damage to target player or \
                       planeswalker equal to the number of Goblins you \
                       control.".into(),
