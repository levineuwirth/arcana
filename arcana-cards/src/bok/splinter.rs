...
//! name as that artifact and exile them. Then that player shuffles."
//!
//! GAP: multi-zone search-and-exile of all cards with the same name is
...
fn resolve(
    ...
    // GAP: multi-zone search for all cards with same name and exile them
