...
fn resolve(
    ...
    // GAP: "search graveyard/hand/library for all cards with the same name and exile them" —
    // no Effect variant searches hidden zones by matching a permanent's name.
