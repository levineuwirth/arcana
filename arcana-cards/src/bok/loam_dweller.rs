//! Loam Dweller — `{1}{G}` 2/2 green Spirit.
//! "Whenever you cast a Spirit or Arcane spell, you may put a land card from
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Loam Dweller");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_triggered_ability(TriggeredAbilityDef {
                id: 1,
                // GAP: "Spirit or Arcane" filter not expressible; using
                // SpellCast(You) as placeholder.
