//! Heron of Hope — {3}{W} 2/3 Bird.
//! Flying. If you would gain life, gain that much plus 1 instead.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Heron of Hope");
    ...
    //      a static life-gain replacement; not a triggered/activated ability.
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{W}: This creature gains lifelink until end of turn.".into(),
                cost: ActivationCost {
