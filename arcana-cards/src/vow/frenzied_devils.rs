//! Frenzied Devils — `{4}{R}` 3/3 Devil with Haste. "Whenever you cast
//! a noncreature spell, this creature gets +2/+2 until end of turn."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Frenzied Devils");
