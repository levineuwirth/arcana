//! Stormchaser Drake — `{1}{U}` 2/1 Drake with Flying.
//! "Whenever this creature becomes the target of a spell you control, draw a
//! card."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Stormchaser Drake");
