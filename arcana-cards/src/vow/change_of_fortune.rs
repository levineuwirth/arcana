//! Change of Fortune — `{3}{R}` sorcery. Discard your hand, then draw
...
fn resolve(
    ...
    // GAP: "this turn's discarded count" is not exposed. Best-effort: draw
    // back exactly the size of the discarded hand.
    vec![
        Effect::Discard {
