//! Broodmate Dragon — `{3}{B}{R}{G}` 4/4 Dragon with Flying.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Broodmate Dragon");
...
fn etb_make_dragon(_state: &GameState, trig: &PendingTrigger, reg: &CardRegistry) -> Vec<Effect> {
