//! Jaddi Offshoot — `{G}` 0/3 Plant with Defender.
//!
//! Defender
//! Landfall — Whenever a land you control enters, you gain 1 life.
//!
//! Defender is a keyword; the landfall trigger is a `ZoneChange` for a land
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Jaddi Offshoot");
