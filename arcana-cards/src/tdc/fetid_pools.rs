//! Fetid Pools — Land — Island Swamp (Amonkhet).
//! "({T}: Add {U} or {B}.)" / "This land enters tapped." /
//! "Cycling {2}"
//!
//! A dual-typed tapland: the Island and Swamp basic land types are
//! interned subtypes; the parenthesized mana abilities are authored
//! explicitly as two mana abilities; Cycling {2} is the parametrized
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Fetid Pools");
