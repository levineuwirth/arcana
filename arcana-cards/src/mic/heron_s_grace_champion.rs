//! Heron's Grace Champion — `{2}{G}{W}` 3/3 Human Knight.
//! Flash, Lifelink.
//! When this creature enters, other Humans you control get +1/+1 and
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Heron's Grace Champion");
