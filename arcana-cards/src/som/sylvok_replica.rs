//! Sylvok Replica — `{3}` 1/3 Artifact Creature — Shaman.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sylvok Replica");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{G}, Sacrifice this creature: Destroy target artifact or enchantment.".into(),
                cost: ActivationCost {
