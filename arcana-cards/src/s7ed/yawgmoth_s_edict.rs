//! Yawgmoth's Edict — `{1}{B}` enchantment.
//! "Whenever an opponent casts a white spell, that player loses 1 life
//! and you gain 1 life."
//!
//! A white-filtered opponent `SpellCast` trigger; "that player" is
//! read via the typed `trig.triggering_caster()` accessor.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Yawgmoth's Edict");
