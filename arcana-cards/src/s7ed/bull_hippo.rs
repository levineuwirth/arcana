//! Bull Hippo — `{3}{G}` 3/3 Hippo with Islandwalk.
//! Mirage common; a green Hippo with islandwalk, threatening
//! Island-controlling blue opponents.
//!
//! # Rules references
//!
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Bull Hippo");
