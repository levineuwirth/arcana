//! Scattered Groves — nonbasic land, subtypes Forest Plains
//! (Amonkhet, 2017). "({T}: Add {G} or {W}.)", "This land enters
//! tapped." and "Cycling {2}."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Scattered Groves");
