...
//! The any-color filter ability is modeled as five separately
//! activatable `{1}, {T}` mana abilities, one per WUBRG color.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Prismatic Lens");
