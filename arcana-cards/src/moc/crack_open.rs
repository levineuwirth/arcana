...
//!
//! GAP: the Treasure token's activated ability ("Tap, sacrifice: Add one mana
//! of any color") cannot be expressed in TokenDefinition.abilities. The token
//! is created as a bare artifact.
...
fn resolve(
    ...
    let token = TokenDefinition {
        ...
        toughness: None,
        keywords: vec![],
        // GAP: "Tap, sacrifice: Add one mana of any color" not expressible
        abilities: vec![],
    };
    vec![
