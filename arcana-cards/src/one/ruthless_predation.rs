//! Ruthless Predation — `{1}{G}` sorcery, "Target creature you
//! control gets +1/+2 until end of turn. It fights target creature
//! you don't control."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Ruthless Predation");
