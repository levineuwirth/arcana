...
//!
//! GAP: "can't block this turn" effect is not in the Effect catalog.
//! The damage-each-opponent-creature is emitted via ForEach.
...
fn resolve(
    ...
    vec![
        ...
        // GAP: "can't block this turn" for opponent creatures
    ]
}
