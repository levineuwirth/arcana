//! Sawblade Scamp — `{R}` 1/1 Phyrexian Beast.
//! Haste.
//! Whenever you cast a noncreature spell, put an oil counter on this creature.
//! {T}, Remove an oil counter from this creature: It deals 1 damage to each
//!   opponent.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sawblade Scamp");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{T}, Remove an oil counter from this creature: It deals 1 damage to each opponent.".into(),
                cost: ActivationCost {
                    tap: true,
...
fn add_oil(_state: &GameState, trig: &PendingTrigger, reg: &CardRegistry) -> Vec<Effect> {
