//! Planar Disruption — `{1}{W}` enchantment — Aura.
//! "Enchant artifact, creature, or planeswalker
//!  Enchanted permanent can't attack or block, and its activated abilities
//!  can't be activated."
//!
//! The can't-attack-or-block restriction is the standard pair of attached
//! markers. "Its activated abilities can't be activated" has no engine
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Planar Disruption");
    ...
    // NOTE: artifact-or-creature-or-planeswalker widened to any permanent.
    reg.register(
...
fn etb_install(_state: &GameState, trig: &PendingTrigger, _: &CardRegistry) -> Vec<Effect> {
    // GAP: "its activated abilities can't be activated".
    vec![
