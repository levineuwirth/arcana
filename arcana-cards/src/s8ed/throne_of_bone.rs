...
//! you gain 1 life." A filtered `SpellCast` trigger (any caster, black
//! spells) whose effect is the `OptionalPayment` may-pay gate.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Throne of Bone");
