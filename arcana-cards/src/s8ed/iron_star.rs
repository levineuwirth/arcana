//! Iron Star — `{1}` artifact (Limited Edition Alpha, 1993).
//! "Whenever a player casts a red spell, you may pay {1}. If you do, you
//! gain 1 life."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Iron Star");
