//! Thunder of Unity — `{R}{W}{B}` red/white/black Enchantment — Saga.
...
//! GAP: Chapter II/III "whenever a creature you control enters this turn" — delayed trigger for this-turn not in catalog.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Thunder of Unity");
...
fn chapter_ii_iii(
    ...
    // GAP: "whenever a creature you control enters this turn, each opponent loses 1 life, you gain 1 life"
    //   — delayed trigger for this-turn not in catalog
    Vec::new()
}
