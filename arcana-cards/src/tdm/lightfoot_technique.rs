//! Lightfoot Technique — `{1}{W}` instant. +1/+1 counter on target creature;
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Lightfoot Technique");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_spell_ability(SpellAbilityDef {
                text: "Put a +1/+1 counter on target creature. It gains flying and indestructible until end of turn.".into(),
