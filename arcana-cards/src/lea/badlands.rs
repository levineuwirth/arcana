//! Badlands — original dual land. "Land — Swamp Mountain", "({T}: Add {B} or
//! {R}.)". Enters untapped with no drawback (no `enters_with`); two basic
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Badlands");
