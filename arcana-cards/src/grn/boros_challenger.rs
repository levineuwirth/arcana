//! Boros Challenger — `{R}{W}` 2/3 red/white Human Soldier with Mentor.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Boros Challenger");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{2}{R}{W}: This creature gets +1/+1 until end of turn.".into(),
            cost: ActivationCost {
