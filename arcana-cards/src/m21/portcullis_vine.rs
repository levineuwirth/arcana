//! Portcullis Vine — `{G}` 0/3 Plant Wall with Defender.
//!
//! Oracle:
//! * Defender
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Portcullis Vine");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{2}, {T}, Sacrifice a creature with defender: Draw a card.".into(),
                cost: ActivationCost {
