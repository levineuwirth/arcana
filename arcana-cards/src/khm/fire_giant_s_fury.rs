...
//! combat damage to a player this turn, exile that many cards from
//! the top of your library. Until the end of your next turn, you may
//! play those cards."
//!
//! GAP: targeting restricted to Giant subtype not enforced at filter
//! level (best-effort uses creature target); rider trigger and
//! play-from-exile permission window are not expressible.
...
fn resolve(
    ...
    // GAP: "whenever it deals combat damage to a player" rider with
    // exile-and-play-from-exile window is not expressible.
    vec![Effect::Pump {
        target: *id,
        power: 2,
        toughness: 2,
