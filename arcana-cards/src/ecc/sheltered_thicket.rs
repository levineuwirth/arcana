//! Sheltered Thicket — Land — Mountain Forest. "({T}: Add {R} or {G}.)
//! This land enters tapped. Cycling {2}." A bicycle land: enters
//! tapped, two basic-land subtypes (the printed mana abilities are
//! wired explicitly), and Cycling {2} via the keyword.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sheltered Thicket");
