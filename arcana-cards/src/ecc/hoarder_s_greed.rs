...
//! process."
//!
//! Clash (and the win-driven repeat loop) has no catalog Effect; we
//! express the single life-loss + draw, gapping the clash loop.
...
fn resolve(_state: &GameState, entry: &StackEntry, _reg: &CardRegistry) -> Vec<Effect> {
    // GAP: clash and the win-driven repeat loop have no catalog Effect.
    vec![
        Effect::LoseLife {
