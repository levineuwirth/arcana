//! Putrefy — `{1}{B}{G}` instant. "Destroy target artifact or creature. It can't be regenerated."
//!
//! # GAP: "can't be regenerated" rider not in engine catalog.
//! Partial: DestroyPermanent artifact-or-creature (without the regeneration prevention).
