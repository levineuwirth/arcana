//! Disdainful Stroke — `{1}{U}` instant. "Counter target spell with mana value
//! 4 or greater."
//!
//! GAP: filtering spells by mana value >= 4 is not expressible with
//! TargetFilter::Spell's ObjectFilter. The spell target is expressed without
