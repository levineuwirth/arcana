//! Sharae of Numbing Depths — `{2}{W}{U}` 2/3 Legendary Merfolk Wizard.
//! ETB: tap target creature an opponent controls and put a stun counter on it.
//! Whenever you tap one or more untapped creatures your opponents control,
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Sharae of Numbing Depths");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            // GAP: trigger fidelity — modeled as "whenever an opponent's
            // creature becomes tapped" (closest variant); the "you tap them"
            // causation is not checked.
            .with_triggered_ability(TriggeredAbilityDef {
                id: 2,
...
fn draw_on_tap(_state: &GameState, trig: &PendingTrigger, _reg: &CardRegistry) -> Vec<Effect> {
