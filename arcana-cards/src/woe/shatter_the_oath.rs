...
//! enchantment. Create a Wicked Role token attached to up to one target
//! creature you control."
//!
//! GAP: Role token (enchantment aura) creation not supported in TokenDefinition.
...
fn resolve(
    ...
    // GAP: Wicked Role token (enchantment aura) creation not supported
