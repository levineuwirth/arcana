//! Cooped Up — `{1}{W}` enchantment — Aura.
//! "Enchant creature. Enchanted creature can't attack or block.
//!  {2}{W}: Exile enchanted creature."
//!
//! ETB installs `attached_cant_attack` + `attached_cant_block` (Pacifism
//! pattern) plus a host-granted "{2}{W}: Exile enchanted creature"
//! activated ability whose cost/effect run against the host (`ctx.source`).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Cooped Up");
