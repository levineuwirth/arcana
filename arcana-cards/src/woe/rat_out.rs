//! Rat Out — `{B}` instant, "Up to one target creature gets -1/-1 until end of turn.
//! You create a 1/1 black Rat creature token with 'This token can't block.'"
//!
//! GAP: Token ability 'This token can't block' is not expressible via keyword list.
...
fn resolve(
    ...
    let token = TokenDefinition {
        ...
        keywords: vec![],
        // GAP: 'This token can't block' ability is not expressible via keyword list
        abilities: vec![],
    };
    let mut effects = vec![
