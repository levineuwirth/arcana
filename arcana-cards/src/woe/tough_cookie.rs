//! Tough Cookie — `{1}{G}` 2/2 Artifact Creature — Food Golem.
//! "When this creature enters, create a Food token."
//! "{2}{G}: Until end of turn, target noncreature artifact you control becomes a
//! 4/4 artifact creature."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Tough Cookie");
    ...
    let chars = Characteristics {
        ...
        // "Food" on the keyword line is the Food artifact subtype (above), not a
...
fn animate_artifact(_state: &GameState, ctx: &ActivationContext, _reg: &CardRegistry) -> Vec<Effect> {
