//! Unruly Catapult — `{2}{R}` 0/4 Artifact Creature — Construct with Defender.
//! "Defender.
//!  {T}: This creature deals 1 damage to each opponent.
//!  Whenever you cast an instant or sorcery spell, untap this creature."
//!
//! Three pieces, all expressible:
//! 1. Defender — base keyword.
//! 2. `{T}` activated → 1 damage to each opponent (Sequence over opponents).
//! 3. SpellCast (instant or sorcery, you) trigger → untap this creature.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Unruly Catapult");
