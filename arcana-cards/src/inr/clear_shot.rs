//! Clear Shot — `{2}{G}` instant. "Target creature you control gets
//! +1/+1 until end of turn. It deals damage equal to its power to
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Clear Shot");
