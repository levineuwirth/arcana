//! Villagers of Estwald // Howlpack of Estwald — `{2}{G}` green Creature — Human Werewolf // Creature — Werewolf.
//! Front: 2/3.
//!   At the beginning of each upkeep, if no spells were cast last turn, transform.
//! ---
//! Back (Howlpack of Estwald): Werewolf 5/5.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Villagers of Estwald");
    ...
    let back_name = reg.interner_mut().intern("Howlpack of Estwald");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            // Back-face trigger: at the beginning of each upkeep, if a player cast
            // two or more spells last turn, transform back.
            // GAP: condition not modeled; fires unconditionally.
