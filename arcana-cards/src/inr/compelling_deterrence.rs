...
//! permanent to its owner's hand. Then that player discards a card if
//! you control a Zombie."
//!
//! The conditional discard (if you control a Zombie) is not
...
fn resolve(_state: &GameState, entry: &StackEntry, _reg: &CardRegistry) -> Vec<Effect> {
    ...
    // GAP: conditional "that player discards if you control a Zombie"
    // not expressible; only the bounce is emitted.
