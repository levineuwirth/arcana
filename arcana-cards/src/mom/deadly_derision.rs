...
//! activated mana ability isn't expressible on a TokenDefinition (no
//! activated-ability primitive on tokens). Emit the destroy; GAP the
//! Treasure activation.
...
fn resolve(
    ...
    // GAP: Treasure token's '{T}, Sacrifice: Add one mana of any
    // color' activated ability (no activated-ability primitive on
    // tokens).
    vec![
