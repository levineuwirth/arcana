//! Referee Squad — `{2}{U}` 2/2 Homunculus with Vigilance.
//! Convoke (unavailable keyword — GAP'd).
//! Vigilance
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Referee Squad");
    ...
    let chars = Characteristics {
        ...
        // GAP: Convoke — not an available keyword.
        ..Default::default()
    };
