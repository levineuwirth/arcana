//! Command Tower — nonbasic land (Commander, 2011).
//! "{T}: Add one mana of any color in your commander's color identity."
//! Modeled as five mana abilities, one per WUBRG color.
//! GAP: the 'in your commander's color identity' restriction is not
//! expressible (commander color identity is not modeled).
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Command Tower");
