//! Viridian Zealot — `{G}{G}` 2/1 green Elf Warrior.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Viridian Zealot");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{G}, Sacrifice this creature: Destroy target artifact or enchantment.".into(),
                cost: ActivationCost {
