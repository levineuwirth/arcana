...
//! graveyard."
//!
//! # GAP: "exile instead of graveyard" replacement on counter is not expressible
//! via the catalog. We emit Effect::Counter and note the replacement gap.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Deny Existence");
