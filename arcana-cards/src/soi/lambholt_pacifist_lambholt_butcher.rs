//! Lambholt Pacifist // Lambholt Butcher — `{1}{G}` Creature — Human Shaman Werewolf 3/3.
//!
//! Front face (Lambholt Pacifist):
//! - This creature can't attack unless you control a creature with power 4 or greater.
//! - At the beginning of each upkeep, if no spells were cast last turn, transform this creature.
//!
//! Back face (Lambholt Butcher — Creature — Werewolf, 5/5):
//! - At the beginning of each upkeep, if a player cast two or more spells last turn,
//!   transform this creature.
//!
//! GAP: "This creature can't attack unless you control a creature with power 4 or greater" —
//! conditional attack restriction is not in the modeled effect/static surface; omitted.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Lambholt Pacifist");
    ...
    // Back face — Lambholt Butcher (Creature — Werewolf, 5/5)
    let back_name = reg.interner_mut().intern("Lambholt Butcher");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            // Front-face trigger (id 1): each upkeep, if no spells were cast last turn,
            // transform this creature.
            ...
            // Back-face trigger (id 2): each upkeep, if a player cast two or more spells
