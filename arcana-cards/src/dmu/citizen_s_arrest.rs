//! Citizen's Arrest — `{1}{W}{W}` enchantment.
//! "When this enchantment enters, exile target creature or planeswalker an
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Citizen's Arrest");
...
/// "…exile target creature or planeswalker an opponent controls until this
