//! Tura Kennerüd, Skyknight — `{2}{W}{U}{U}` 3/3 Legendary Creature — Human
//! Knight with Flying. "Whenever you cast an instant or sorcery spell, create
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Tura Kennerüd, Skyknight");
