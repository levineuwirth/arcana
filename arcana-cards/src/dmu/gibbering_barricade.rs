//! Gibbering Barricade — `{2}{B}` 2/4 Nightmare Wall with Defender.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Gibbering Barricade");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_activated_ability(ActivatedAbilityDef {
            text: "{2}{B}, Sacrifice a creature: You gain 1 life and draw a card.".into(),
            cost: ActivationCost {
