...
//! {T}: Add one mana of any color. (GAP — no any-color mana primitive.)
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    ...
    // GAP: "{T}: Add one mana of any color" — there is no any-color mana
    // Effect primitive (AddMana takes concrete ManaUnits); hardcoding a color
    // would be materially wrong, so this mana ability is omitted.
    reg.register(
