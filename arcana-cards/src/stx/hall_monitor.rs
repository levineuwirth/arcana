//! Hall Monitor — `{R}` 1/1 Lizard Shaman with Haste.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Hall Monitor");
...
fn forbid_blocking(_state: &GameState, ctx: &ActivationContext, _reg: &CardRegistry) -> Vec<Effect> {
