//! Ageless Guardian — vanilla 1/4 white creature for `{1}{W}`.
//! No abilities; a Spirit Soldier with high toughness for its cost.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Ageless Guardian");
