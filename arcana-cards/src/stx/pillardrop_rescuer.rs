//! Pillardrop Rescuer — `{4}{W}` 2/2 Spirit Cleric with Flying.
//!
//! Oracle:
//! * Flying — keyword, base characteristic.
//! * "When this creature enters, return target creature card with mana value 3
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Pillardrop Rescuer");
