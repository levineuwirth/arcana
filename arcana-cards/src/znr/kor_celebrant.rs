//! Kor Celebrant — `{2}{W}` 1/4 white Kor Cleric.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Kor Celebrant");
    ...
    reg.register(
        CardDefinition::new(name, chars).with_triggered_ability(TriggeredAbilityDef {
            ...
            intervening_if: None,
            effect: on_creature_enters_gain_life,
...
fn on_creature_enters_gain_life(
    _state: &GameState,
    trig: &PendingTrigger,
    _reg: &CardRegistry,
) -> Vec<Effect> {
