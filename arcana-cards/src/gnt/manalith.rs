...
//! WUBRG color — choosing which to activate IS the color choice
//! (the catalog-wide idiom for "Add one mana of any color").
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Manalith");
