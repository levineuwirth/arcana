//! Defensive Stance — `{U}` enchantment — Aura.
//! "Enchant creature
//!  Enchanted creature gets -1/+1."
//!
//! The canonical buff/debuff Aura: an ETB-installed attached_pt of -1/+1.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Defensive Stance");
