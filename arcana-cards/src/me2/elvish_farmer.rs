...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Elvish Farmer");
    let elf = reg.interner_mut().intern("Elf");
    let spore = reg.interner_mut().intern("spore");
    let _saproling_token = reg.interner_mut().intern("Saproling");
    ...
    let saproling_sac_filter = script::subtype_filter(reg, "Saproling")
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                ...
                cost: ActivationCost {
                    sacrifice_other: Some(saproling_sac_filter),
                    ..ActivationCost::default()
                },
                target_requirements: Vec::new(),
                is_mana_ability: false,
...
fn make_saproling(
    ...
    let Some(saproling) = reg.interner().lookup("Saproling") else {
        return Vec::new();
    };
    let mut subtypes = SubtypeSet::default();
