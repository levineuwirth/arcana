//! Feral Thallid — `{3}{G}{G}{G}` 6/3 green Fungus.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Feral Thallid");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "Remove three spore counters from this creature: Regenerate this creature.".into(),
                cost: ActivationCost {
