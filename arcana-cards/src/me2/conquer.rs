//! Conquer — `{3}{R}{R}` enchantment — Aura.
//! "Enchant land
//!  You control enchanted land."
//!
//! Control-change Aura (Control Magic family). On ETB (id 1) the host is
//! `source.attached_to`; we `ChangeControl` it to the Aura's controller, and
//! on the Aura leaving (id 2) revert control to the host's owner.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Conquer");
