//! Rabanastre, Royal City — nonbasic land, subtype Town.
//! "This land enters tapped." and "{T}: Add {R} or {W}." The tapland
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Rabanastre, Royal City");
