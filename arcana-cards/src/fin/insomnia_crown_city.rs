//! Insomnia, Crown City — nonbasic land, subtype Town.
//! "This land enters tapped." and "{T}: Add {W} or {B}." The tapland
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Insomnia, Crown City");
