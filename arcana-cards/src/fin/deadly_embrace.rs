...
//!
//! GAP: "draw a card for each creature that died this turn" requires tracking
//! creatures that died this turn — dynamic count not expressible.
...
fn resolve(
    ...
    vec![
        ...
        // GAP: draw a card for each creature that died this turn —
        // requires tracking deaths this turn, no such engine variant
    ]
}
