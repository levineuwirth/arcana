//! Treno, Dark City — nonbasic land — Town (Final Fantasy).
//! "This land enters tapped." and "{T}: Add {U} or {B}."
//!
//! The tapland archetype: `EntersWithSpec::Tapped` plus a two-color
//! mana choice modeled as two separate mana abilities.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Treno, Dark City");
