//! Gohn, Town of Ruin — nonbasic land, subtype Town.
//! "This land enters tapped." and "{T}: Add {B} or {G}." The tapland
//! archetype with the Town subtype interned.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Gohn, Town of Ruin");
