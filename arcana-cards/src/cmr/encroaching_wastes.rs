//! Encroaching Wastes — nonbasic land.
//! "{T}: Add {C}." and "{4}, {T}, Sacrifice this land: Destroy target
//! nonbasic land."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Encroaching Wastes");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{4}, {T}, Sacrifice this land: Destroy target \
                       nonbasic land."
                    .into(),
                cost: ActivationCost {
