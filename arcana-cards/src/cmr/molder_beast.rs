//! Molder Beast — `{4}{G}` 5/3 Beast with Trample.
//! Whenever an artifact is put into a graveyard from the battlefield, this
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Molder Beast");
