...
//!
//! GAP: the 'creature with flying' option requires filtering by keyword
//! possession which is not expressible; using a broader permanent filter.
...
fn resolve(
    ...
    // GAP: flying-creature filter not expressible; all creatures accepted
