//! Silverchase Fox — `{1}{W}` 2/2 white Fox.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Silverchase Fox");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{W}, Sacrifice this creature: Exile target enchantment.".into(),
                cost: ActivationCost {
