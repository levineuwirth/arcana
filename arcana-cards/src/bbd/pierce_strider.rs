//! Pierce Strider — `{4}` 3/3 colorless Artifact Phyrexian Construct.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Pierce Strider");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_triggered_ability(TriggeredAbilityDef {
                ...
                intervening_if: None,
                effect: target_opponent_lose_life,
