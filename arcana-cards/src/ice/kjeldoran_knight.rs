//! Kjeldoran Knight — `{W}{W}` 1/1 white Creature — Human Knight.
//! Banding.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Kjeldoran Knight");
    ...
    reg.register(
        CardDefinition::new(name, chars)
            .with_activated_ability(ActivatedAbilityDef {
                text: "{1}{W}: This creature gets +1/+0 until end of turn.".into(),
                cost: ActivationCost {
            ...
            .with_activated_ability(ActivatedAbilityDef {
                text: "{W}{W}: This creature gets +0/+2 until end of turn.".into(),
                cost: ActivationCost {
