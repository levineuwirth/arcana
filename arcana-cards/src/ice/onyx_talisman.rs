...
//! "Whenever a player casts a black spell, you may pay {3}. If you
//! do, untap target permanent." A SpellCast trigger (black filter,
//! any caster) with a targeted optional-payment untap.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Onyx Talisman");
