//! Grizzled Wolverine — `{1}{R}{R}` 2/2 red Wolverine.
//! "{R}: This creature gets +2/+0 until end of turn. Activate only during
//! the declare blockers step, only if at least one creature is blocking this
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Grizzled Wolverine");
