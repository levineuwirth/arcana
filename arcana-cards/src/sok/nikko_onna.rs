//! Nikko-Onna — `{2}{W}` 2/2 Spirit.
//! When this creature enters, destroy target enchantment.
//! Whenever you cast a Spirit or Arcane spell, you may return this creature to
//! its owner's hand.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Nikko-Onna");
...
fn return_self(_state: &GameState, trig: &PendingTrigger, _reg: &CardRegistry) -> Vec<Effect> {
    // "you may return this creature to its owner's hand" — the may is a
    // resolution-time choice handled by the engine's optional-return posture.
