...
//! cards in your hand."
//! Note: type line is "Instant — Arcane"; the engine models only INSTANT; the
//! Arcane subtype is not separately expressible.
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Inner Calm, Outer Strength");
