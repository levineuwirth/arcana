//! Skull Collector — `{1}{B}{B}` 3/3 Ogre Warrior.
//! "At the beginning of your upkeep, return a black creature you control
//! to its owner's hand."
...
pub fn register(reg: &mut CardRegistry) -> CardId {
    let name = reg.interner_mut().intern("Skull Collector");
