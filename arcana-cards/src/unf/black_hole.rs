...
//! visited this turn."
//!
//! GAP: Attractions-visited counter tracking not available; only the single
//! primary target can be expressed.
...
fn resolve(
    ...
    // GAP: X = Attractions visited this turn; only first target handled
