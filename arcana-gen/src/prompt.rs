...
- Keywords (unit variants, fully implemented): `KeywordAbility::Flying`, `Vigilance`, `Reach`, `Trample`, `Haste`, `Lifelink`, `Deathtouch`, `FirstStrike`, `DoubleStrike`, `Menace`, `Defender`, `Hexproof`, `Shroud`, `Indestructible`, `Flash`, `Fear`, `Intimidate`, `Shadow`, `Horsemanship`, `Skulk`, `Wither`, `Infect`, `Undying`, `Persist`, `Exalted`, `BattleCry`, `Mentor`, `Dethrone`, `Enlist`, `Flanking`, `Provoke`, `Sunburst`, `Unleash`, `Riot`. Place in `Characteristics.keywords` as a `Vec<KeywordAbility>`. (Scryfall `Battle cry` → `KeywordAbility::BattleCry`.)
