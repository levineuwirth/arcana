...
> Equip/Enchant/Crew statuses (aura-attach, equip, and crew wiring have
> since landed), and the "deliberate simplifications" table, several of
> whose items have since been converted to real player choices.
